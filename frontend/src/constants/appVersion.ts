export const APP_VERSION = '3.66.8';
export const APP_VERSION_NAME = 'Page RelevÃƒÆ’Ã‚Â©s (module Eau) : en faisant dÃƒÆ’Ã‚Â©filer la page, les onglets Compteurs / Source restent dÃƒÆ’Ã‚Â©sormais collÃƒÆ’Ã‚Â©s juste sous l\'en-tÃƒÆ’Ã‚Âªte (le reste de la page glisse dessous). La saisie d\'un relevÃƒÆ’Ã‚Â© de compteur accepte une date et heure facultative ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â laissÃƒÆ’Ã‚Â©e vide, le relevÃƒÆ’Ã‚Â© est horodatÃƒÆ’Ã‚Â© maintenant ; renseignÃƒÆ’Ã‚Â©e, on peut saisir un relevÃƒÆ’Ã‚Â© passÃƒÆ’Ã‚Â© (une date future est refusÃƒÆ’Ã‚Â©e) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â avec l\'index et la date affichÃƒÆ’Ã‚Â©s sur une mÃƒÆ’Ã‚Âªme ligne. En mode ÃƒÆ’Ã‚Â©dition (admin), la date et l\'index d\'un relevÃƒÆ’Ã‚Â© passent aussi cÃƒÆ’Ã‚Â´te ÃƒÆ’Ã‚Â  cÃƒÆ’Ã‚Â´te. Les deux raccourcis du bas reprennent les icÃƒÆ’Ã‚Â´nes des cartes de saisie de la source (verre d\'eau pour Ãƒâ€šÃ‚Â« Saisir bassin Ãƒâ€šÃ‚Â», flÃƒÆ’Ã‚Â¨che d\'entrÃƒÆ’Ã‚Â©e pour Ãƒâ€šÃ‚Â« Ajouter apport Ãƒâ€šÃ‚Â»). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.62.0 : Module Eau : corrections et fiabilitÃƒÆ’Ã‚Â© (sans changement d\'usage). Le graphique Tendances affiche dÃƒÆ’Ã‚Â©sormais les deux courbes de consommation (mesurÃƒÆ’Ã‚Â©e et estimÃƒÆ’Ã‚Â©e) alignÃƒÆ’Ã‚Â©es sur le mÃƒÆ’Ã‚Âªme jour, mÃƒÆ’Ã‚Âªme tÃƒÆ’Ã‚Â´t le matin (fuseau de Madagascar) ; les alertes ne se dÃƒÆ’Ã‚Â©doublent plus autour de minuit ; les ÃƒÆ’Ã‚Â©crans ne restent plus bloquÃƒÆ’Ã‚Â©s sur un rond qui tourne en cas de coupure rÃƒÆ’Ã‚Â©seau ; aprÃƒÆ’Ã‚Â¨s import de contacts, supprimer une ligne au milieu de la liste ne dÃƒÆ’Ã‚Â©cale plus les autres champs. Suppressions plus sÃƒÆ’Ã‚Â»res hors connexion : un relevÃƒÆ’Ã‚Â© ou un compteur supprimÃƒÆ’Ã‚Â© sans rÃƒÆ’Ã‚Â©seau est bien conservÃƒÆ’Ã‚Â© puis appliquÃƒÆ’Ã‚Â© au serveur au retour en ligne (la ligne ne rÃƒÆ’Ã‚Â©apparaÃƒÆ’Ã‚Â®t plus), et le recalcul des bilans ne crÃƒÆ’Ã‚Â©e plus de doublons. Les factures PDF passent au vert AHUVI (fini le bleu). Nettoyage interne sans effet visible. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.60.2 : Correctif de mise en ligne : des fonctions utilisÃƒÆ’Ã‚Â©es par le tableau de bord eau (affichage des dÃƒÆ’Ã‚Â©bits en mÃƒâ€šÃ‚Â³/h, de la puissance en kW, et la consommation ÃƒÆ’Ã‚Â©lectrique rÃƒÆ’Ã‚Â©cente) avaient ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â©crites mais jamais publiÃƒÆ’Ã‚Â©es, ce qui empÃƒÆ’Ã‚Âªchait la fabrication de la version en ligne (le site restait bloquÃƒÆ’Ã‚Â© sur une version antÃƒÆ’Ã‚Â©rieure). Ces fonctions sont maintenant publiÃƒÆ’Ã‚Â©es : toutes les ÃƒÆ’Ã‚Â©volutions rÃƒÆ’Ã‚Â©centes du module Eau deviennent visibles en ligne. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.60.1 : Gestion Eau (sur tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone) : la bande systÃƒÆ’Ã‚Â¨me tout en haut de l\'ÃƒÆ’Ã‚Â©cran (heure, rÃƒÆ’Ã‚Â©seau, batterie) n\'est plus violette dans le module Eau ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â elle prend la couleur verte du bandeau AHUVI. Le violet reste utilisÃƒÆ’Ã‚Â© dans BazarKELY et Construction. ÃƒÆ’Ã¢â€šÂ¬ noter : la barre d\'ÃƒÆ’Ã‚Â©tat du systÃƒÆ’Ã‚Â¨me ne peut afficher qu\'une couleur unie (l\'effet translucide/flou du bandeau ne peut pas y ÃƒÆ’Ã‚Âªtre reproduit) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â on y met donc le vert dominant du bandeau. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.60.0 : le sÃƒÆ’Ã‚Â©lecteur de pÃƒÆ’Ã‚Â©riode en haut ÃƒÆ’Ã‚Â  droite devient un vrai menu dÃƒÆ’Ã‚Â©roulant soignÃƒÆ’Ã‚Â©. Au lieu du menu gris du navigateur, il ouvre dÃƒÆ’Ã‚Â©sormais un petit panneau aux couleurs de l\'app (coins arrondis, ombre douce, option active surlignÃƒÆ’Ã‚Â©e avec une coche), avec une animation d\'ouverture fluide faÃƒÆ’Ã‚Â§on iOS (apparition vive puis arrivÃƒÆ’Ã‚Â©e en douceur, sans rebond). Il se ferme en touchant ailleurs ou avec la touche ÃƒÆ’Ã¢â‚¬Â°chap, et respecte le rÃƒÆ’Ã‚Â©glage Ãƒâ€šÃ‚Â« animations rÃƒÆ’Ã‚Â©duites Ãƒâ€šÃ‚Â» du tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone. Le choix et son effet sur les chiffres ne changent pas. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.9 : l\'icÃƒÆ’Ã‚Â´ne de la carte Ãƒâ€šÃ‚Â« Stock actuel Ãƒâ€šÃ‚Â» passe de la goutte ÃƒÆ’Ã‚Â  un verre/contenant avec niveau d\'eau (plus parlant pour le Ãƒâ€šÃ‚Â« remplissage Ãƒâ€šÃ‚Â» du bassin et pour ÃƒÆ’Ã‚Â©viter d\'avoir deux gouttes identiques). Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â» garde la goutte. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.8 : l\'icÃƒÆ’Ã‚Â´ne de la carte Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» change ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â l\'ancien symbole pourcentage (hÃƒÆ’Ã‚Â©ritÃƒÆ’Ã‚Â© du Ãƒâ€šÃ‚Â« NRW Ãƒâ€šÃ‚Â») est remplacÃƒÆ’Ã‚Â© par une loupe barrÃƒÆ’Ã‚Â©e (eau qui ÃƒÆ’Ã‚Â©chappe au comptage), plus parlant et qui ne fait plus doublon avec les gouttes des autres cartes. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.7 : la carte Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â» affiche dÃƒÆ’Ã‚Â©sormais, ÃƒÆ’Ã‚Â  droite de sa valeur, sa part de la Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â» (en gris) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â comme la carte Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â». Les deux pourcentages se complÃƒÆ’Ã‚Â¨tent (ÃƒÂ¢Ã¢â‚¬Â°Ã‹â€  100 %). PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.6 : la carte Ãƒâ€šÃ‚Â« Autonomie estimÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» affiche dÃƒÆ’Ã‚Â©sormais, ÃƒÆ’Ã‚Â  droite de la consommation moyenne par jour (mÃƒâ€šÃ‚Â³/j), son ÃƒÆ’Ã‚Â©quivalent par heure (mÃƒâ€šÃ‚Â³/h) en gris. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.5 : la carte Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â» n\'affiche plus qu\'une seule ligne sous sa valeur (le volume Ãƒâ€šÃ‚Â« X mÃƒâ€šÃ‚Â³ sur la pÃƒÆ’Ã‚Â©riode Ãƒâ€šÃ‚Â») ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â la petite mention d\'origine du chiffre (Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â»/Ãƒâ€šÃ‚Â« mesurÃƒÆ’Ã‚Â©e ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â») est retirÃƒÆ’Ã‚Â©e. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.4 : le pourcentage d\'eau non comptÃƒÆ’Ã‚Â©e s\'affiche dÃƒÆ’Ã‚Â©sormais en gris ÃƒÆ’Ã‚Â  droite de la valeur de la carte Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» elle-mÃƒÆ’Ã‚Âªme (et non plus sur la carte Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â»). PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.3 : le pourcentage d\'eau non comptÃƒÆ’Ã‚Â©e (part de la Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â») est dÃƒÆ’Ã‚Â©placÃƒÆ’Ã‚Â© ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â il s\'affiche dÃƒÆ’Ã‚Â©sormais en gris ÃƒÆ’Ã‚Â  droite de la valeur de la carte Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â», et la ligne grise sous la carte Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» est retirÃƒÆ’Ã‚Â©e (cette carte ne montre plus que son dÃƒÆ’Ã‚Â©bit et son volume Ãƒâ€šÃ‚Â« hors compteur Ãƒâ€šÃ‚Â»). PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.2 : Gestion Eau, tableau de bord : la carte Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» s\'affiche dÃƒÆ’Ã‚Â©sormais comme les autres indicateurs ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â en dÃƒÆ’Ã‚Â©bit (mÃƒâ€šÃ‚Â³/h) au lieu d\'un pourcentage. Le grand chiffre est le dÃƒÆ’Ã‚Â©bit d\'eau non comptÃƒÆ’Ã‚Â©e, le sous-texte indique le volume Ãƒâ€šÃ‚Â« X mÃƒâ€šÃ‚Â³ hors compteur Ãƒâ€šÃ‚Â», et une ligne grise prÃƒÆ’Ã‚Â©cise le pourcentage que cela reprÃƒÆ’Ã‚Â©sente par rapport ÃƒÆ’Ã‚Â  la Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â». Comme les cartes voisines, elle suit la pÃƒÆ’Ã‚Â©riode choisie en haut ÃƒÆ’Ã‚Â  droite. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.1 : Gestion Eau, tableau de bord : la carte Ãƒâ€šÃ‚Â« NRW (pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â» est renommÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â». Le chiffre (en %) et le volume affichÃƒÆ’Ã‚Â© sont les mÃƒÆ’Ã‚Âªmes qu\'avant, mais le libellÃƒÆ’Ã‚Â© dit dÃƒÆ’Ã‚Â©sormais la vÃƒÆ’Ã‚Â©ritÃƒÆ’Ã‚Â© : c\'est l\'eau sortie du bassin mais pas (encore) comptÃƒÆ’Ã‚Â©e ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â villas sans compteur, parties communes, arrosage du golf ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â plus les vraies pertes ; ce n\'est un Ãƒâ€šÃ‚Â« taux de pertes Ãƒâ€šÃ‚Â» que lorsque tous les usages seront comptÃƒÆ’Ã‚Â©s. La carte passe au jaune (Ãƒâ€šÃ‚Â« ÃƒÆ’Ã‚Â  surveiller Ãƒâ€šÃ‚Â») au lieu du rouge (Ãƒâ€šÃ‚Â« perte Ãƒâ€šÃ‚Â»), et le sous-texte indique Ãƒâ€šÃ‚Â« X mÃƒâ€šÃ‚Â³ non comptÃƒÆ’Ã‚Â©s sur la pÃƒÆ’Ã‚Â©riode Ãƒâ€šÃ‚Â». Garde-fous : si le dÃƒÆ’Ã‚Â©bit des pompes n\'est pas connu (aucun test de dÃƒÆ’Ã‚Â©bit), la carte affiche Ãƒâ€šÃ‚Â« ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Ãƒâ€šÃ‚Â» avec Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit des pompes requis Ãƒâ€šÃ‚Â» ; et un ÃƒÆ’Ã‚Â©cart nÃƒÆ’Ã‚Â©gatif aberrant (compteurs au-dessus de la sortie estimÃƒÆ’Ã‚Â©e) n\'affiche plus de pourcentage absurde. PrÃƒÆ’Ã‚Â©sentation uniquement : les calculs (Phase prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dente) ne changent pas. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.59.0 : Gestion Eau, tableau de bord : la Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â» (eau sortie du bassin) est dÃƒÆ’Ã‚Â©sormais calculÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  partir du DÃƒÆ’Ã¢â‚¬Â°BIT des pompes ÃƒÆ’Ã¢â‚¬â€ leur TEMPS DE MARCHE rÃƒÆ’Ã‚Â©el (temps ÃƒÆ’Ã‚Â©coulÃƒÆ’Ã‚Â© moins les arrÃƒÆ’Ã‚Âªts de pompe que vous saisissez), au lieu d\'un calcul qui se plafonnait au niveau du flotteur et rendait le chiffre incohÃƒÆ’Ã‚Â©rent (la conso rÃƒÆ’Ã‚Â©seau pouvait tomber sous la conso comptÃƒÆ’Ã‚Â©e, d\'oÃƒÆ’Ã‚Â¹ un Ãƒâ€šÃ‚Â« NRW Ãƒâ€šÃ‚Â» nÃƒÆ’Ã‚Â©gatif aberrant). ConsÃƒÆ’Ã‚Â©quences : Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â» reflÃƒÆ’Ã‚Â¨te maintenant l\'eau rÃƒÆ’Ã‚Â©ellement dÃƒÆ’Ã‚Â©livrÃƒÆ’Ã‚Â©e, et l\'ÃƒÆ’Ã‚Â©cart avec la Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â» (affichÃƒÆ’Ã‚Â© pour l\'instant dans la carte NRW) redevient positif et cohÃƒÆ’Ã‚Â©rent ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â c\'est en rÃƒÆ’Ã‚Â©alitÃƒÆ’Ã‚Â© de l\'EAU NON COMPTÃƒÆ’Ã¢â‚¬Â°E (villas sans compteur, parties communes, arrosage du golf) plus les vraies pertes ; le renommage de cette carte en Ãƒâ€šÃ‚Â« Eau non comptÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» viendra ÃƒÆ’Ã‚Â  l\'ÃƒÆ’Ã‚Â©tape suivante. Cette eau non comptÃƒÆ’Ã‚Â©e n\'est PLUS traitÃƒÆ’Ã‚Â©e comme une anomalie (elle est normale tant que tout n\'est pas comptÃƒÆ’Ã‚Â©). Le calcul du stock attendu, des ÃƒÆ’Ã‚Â©carts de niveau et la facturation (basÃƒÆ’Ã‚Â©e sur les compteurs) ne changent pas. IMPORTANT : pour appliquer ces nouveaux chiffres aux relevÃƒÆ’Ã‚Â©s DÃƒÆ’Ã¢â‚¬Â°JÃƒÆ’Ã¢â€šÂ¬ enregistrÃƒÆ’Ã‚Â©s, l\'administrateur lance une fois Ãƒâ€šÃ‚Â« Recalculer tous les bilans Ãƒâ€šÃ‚Â» (onglet Source ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s rÃƒÆ’Ã‚Â©cents Ãƒâ€šÃ‚Â»). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.58.0 : Gestion Eau, page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â», onglet Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â» : nouvelle section dÃƒÆ’Ã‚Â©pliable Ãƒâ€šÃ‚Â« ArrÃƒÆ’Ã‚Âªts de pompe Ãƒâ€šÃ‚Â». On peut dÃƒÆ’Ã‚Â©sormais noter les pÃƒÆ’Ã‚Â©riodes pendant lesquelles les pompes ÃƒÆ’Ã‚Â©taient ÃƒÆ’Ã‚Â  l\'arrÃƒÆ’Ã‚Âªt, au choix de deux faÃƒÆ’Ã‚Â§ons : soit en indiquant l\'heure de dÃƒÆ’Ã‚Â©but ET de fin, soit en indiquant l\'heure de dÃƒÆ’Ã‚Â©but ET une durÃƒÆ’Ã‚Â©e (en minutes). Chaque arrÃƒÆ’Ã‚Âªt enregistrÃƒÆ’Ã‚Â© apparaÃƒÆ’Ã‚Â®t dans une liste (avec sa durÃƒÆ’Ã‚Â©e) et peut ÃƒÆ’Ã‚Âªtre supprimÃƒÆ’Ã‚Â©. Ces donnÃƒÆ’Ã‚Â©es serviront prochainement ÃƒÆ’Ã‚Â  estimer plus justement l\'eau rÃƒÆ’Ã‚Â©ellement apportÃƒÆ’Ã‚Â©e par les pompes (leur Ãƒâ€šÃ‚Â« temps de marche Ãƒâ€šÃ‚Â» = temps ÃƒÆ’Ã‚Â©coulÃƒÆ’Ã‚Â© moins les arrÃƒÆ’Ã‚Âªts) ; pour l\'instant, cette saisie n\'a AUCUN effet sur les chiffres du tableau de bord. Tout est enregistrÃƒÆ’Ã‚Â© et synchronisÃƒÆ’Ã‚Â© comme les autres relevÃƒÆ’Ã‚Â©s et fonctionne hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.7 : Tableau de bord Gestion Eau : sous la carte Ãƒâ€šÃ‚Â« Pompes en marche Ãƒâ€šÃ‚Â», le texte Ãƒâ€šÃ‚Â« Apport des pompes Ãƒâ€šÃ‚Â» devient Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit entrant Ãƒâ€šÃ‚Â». PrÃƒÆ’Ã‚Â©sentationnel uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.6 : la carte Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit source Ãƒâ€šÃ‚Â» est renommÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â« Pompes en marche Ãƒâ€šÃ‚Â» (titre raccourci). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.5 : la carte Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit source Ãƒâ€šÃ‚Â» est renommÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit pompes en marche Ãƒâ€šÃ‚Â» (le dÃƒÆ’Ã‚Â©bit instantanÃƒÆ’Ã‚Â© des pompes quand elles tournent). Renommage d\'affichage uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.4 : Tableau de bord Gestion Eau : deux cartes d\'indicateurs sont renommÃƒÆ’Ã‚Â©es pour lever l\'ambiguÃƒÆ’Ã‚Â¯tÃƒÆ’Ã‚Â© entre l\'eau facturable et l\'eau sortie du bassin. Ãƒâ€šÃ‚Â« Conso (pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â» devient Ãƒâ€šÃ‚Â« Conso au compteur Ãƒâ€šÃ‚Â» (l\'eau rÃƒÆ’Ã‚Â©ellement comptÃƒÆ’Ã‚Â©e aux compteurs des villas, c\'est-ÃƒÆ’Ã‚Â -dire la consommation facturable) et Ãƒâ€šÃ‚Â« Conso rÃƒÆ’Ã‚Â©seau (pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â» devient Ãƒâ€šÃ‚Â« Conso du rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â» (toute l\'eau sortie du bassin vers les canalisations = consommation + pertes). La carte Ãƒâ€šÃ‚Â« NRW Ãƒâ€šÃ‚Â» affiche, elle, la diffÃƒÆ’Ã‚Â©rence (les pertes). La pÃƒÆ’Ã‚Â©riode reste indiquÃƒÆ’Ã‚Â©e sous chaque valeur. Renommage d\'affichage uniquement : aucun calcul ni donnÃƒÆ’Ã‚Â©e modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.3 : Tableau de bord Gestion Eau : le sous-titre cliquable de l\'en-tÃƒÆ’Ã‚Âªte est raccourci en Ãƒâ€šÃ‚Â« Tableau de bord Ãƒâ€šÃ‚Â» (au lieu de Ãƒâ€šÃ‚Â« Tableau de bord du bassin et des compteurs Ãƒâ€šÃ‚Â») pour ÃƒÆ’Ã‚Â©viter qu\'il passe sur deux lignes. PrÃƒÆ’Ã‚Â©sentation uniquement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.2 : Tableau de bord Gestion Eau : petite retouche du sÃƒÆ’Ã‚Â©lecteur de pÃƒÆ’Ã‚Â©riode en haut ÃƒÆ’Ã‚Â  droite ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â la bordure propre du menu dÃƒÆ’Ã‚Â©roulant est supprimÃƒÆ’Ã‚Â©e et la petite flÃƒÆ’Ã‚Â¨che Ãƒâ€šÃ‚Â« V Ãƒâ€šÃ‚Â» ÃƒÆ’Ã‚Â  droite du texte est retirÃƒÆ’Ã‚Â©e. PrÃƒÆ’Ã‚Â©sentation uniquement, rien d\'autre ne change. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.1 : Tableau de bord Gestion Eau : finitions de prÃƒÆ’Ã‚Â©sentation. Le sÃƒÆ’Ã‚Â©lecteur de pÃƒÆ’Ã‚Â©riode en haut ÃƒÆ’Ã‚Â  droite (Ãƒâ€šÃ‚Â« Depuis minuit / Sur 24 h / Sur la pÃƒÆ’Ã‚Â©riode Ãƒâ€šÃ‚Â») adopte pleinement la charte AHUVI (icÃƒÆ’Ã‚Â´ne calendrier verte, petite flÃƒÆ’Ã‚Â¨che vers le bas, fond blanc, plus aucune teinte bleue). Dans les indicateurs, deux cartes changent d\'ordre : ÃƒÆ’Ã‚Â  gauche, Ãƒâ€šÃ‚Â« DÃƒÆ’Ã‚Â©bit source Ãƒâ€šÃ‚Â» passe au-dessus de Ãƒâ€šÃ‚Â« EntrÃƒÆ’Ã‚Â©es Ãƒâ€šÃ‚Â» (Stock actuel Ãƒâ€šÃ‚Â· DÃƒÆ’Ã‚Â©bit source Ãƒâ€šÃ‚Â· EntrÃƒÆ’Ã‚Â©es) ; ÃƒÆ’Ã‚Â  droite, Ãƒâ€šÃ‚Â« Conso rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â» passe tout en haut (Conso rÃƒÆ’Ã‚Â©seau Ãƒâ€šÃ‚Â· Conso Ãƒâ€šÃ‚Â· NRW Ãƒâ€šÃ‚Â· Autonomie estimÃƒÆ’Ã‚Â©e). RÃƒÆ’Ã‚Â©organisation et habillage uniquement : aucun chiffre, calcul ni fonctionnement (y compris hors connexion) n\'est modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.57.0 : Module Gestion Eau, page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â», onglet Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â» : les deux cartes du haut qui parlaient toutes deux du bassin sont fusionnÃƒÆ’Ã‚Â©es en une seule. La carte Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» disparaÃƒÆ’Ã‚Â®t : son dernier relevÃƒÆ’Ã‚Â© (hauteur, volume, date) et ses boutons sont dÃƒÆ’Ã‚Â©sormais intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â©s dans la carte Ãƒâ€šÃ‚Â« Stock d\'eau du bassin Ãƒâ€šÃ‚Â». Sous les chiffres Attendu/ÃƒÆ’Ã¢â‚¬Â°cart figure maintenant une rangÃƒÆ’Ã‚Â©e avec, ÃƒÆ’Ã‚Â  gauche, le dernier relevÃƒÆ’Ã‚Â© (toucher ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ l\'historique des niveaux) et, ÃƒÆ’Ã‚Â  droite, le petit crayon (toucher ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ la saisie d\'une hauteur). Toucher le reste de la carte ouvre toujours l\'explication Ãƒâ€šÃ‚Â« Comprendre cette situation Ãƒâ€šÃ‚Â». ÃƒÆ’Ã¢â€šÂ¬ l\'ouverture de la saisie ou de l\'historique, la carte glisse pour se placer juste sous l\'en-tÃƒÆ’Ã‚Âªte, comme avant. Changement de prÃƒÆ’Ã‚Â©sentation uniquement : les calculs, la saisie, les raccourcis et le fonctionnement hors connexion sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.56.1 : Dans la barre du bas, Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» passe avant Ãƒâ€šÃ‚Â« Suivi Ãƒâ€šÃ‚Â». (2) Sur la page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â» (onglet Compteurs), un nouveau bouton (ÃƒÆ’Ã‚Â  droite de Ãƒâ€šÃ‚Â« Scan Ãƒâ€šÃ‚Â») ouvre directement la crÃƒÆ’Ã‚Â©ation d\'un compteur. (3) La page Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» peut dÃƒÆ’Ã‚Â©sormais s\'ouvrir avec le formulaire de crÃƒÆ’Ã‚Â©ation dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  dÃƒÆ’Ã‚Â©pliÃƒÆ’Ã‚Â©. (4) ÃƒÆ’Ã¢â€šÂ¬ l\'ouverture du formulaire de crÃƒÆ’Ã‚Â©ation, la page glisse pour le placer juste sous l\'en-tÃƒÆ’Ã‚Âªte. (5) Le bouton Ãƒâ€šÃ‚Â« Modifier Ãƒâ€šÃ‚Â» d\'un compteur ouvre maintenant un tiroir d\'ÃƒÆ’Ã‚Â©dition directement SOUS la carte concernÃƒÆ’Ã‚Â©e (au lieu du haut de la liste), et la carte glisse sous l\'en-tÃƒÆ’Ã‚Âªte ; un seul tiroir d\'ÃƒÆ’Ã‚Â©dition ÃƒÆ’Ã‚Â  la fois. (6) Les boutons d\'action des cartes compteur (QR, Modifier, Supprimer) n\'affichent plus que leur icÃƒÆ’Ã‚Â´ne (une bulle d\'aide apparaÃƒÆ’Ã‚Â®t au survol). Changements de navigation et d\'affichage uniquement : aucun calcul, libellÃƒÆ’Ã‚Â© mÃƒÆ’Ã‚Â©tier ni donnÃƒÆ’Ã‚Â©e n\'est modifiÃƒÆ’Ã‚Â©, et l\'application reste utilisable hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.54.0 : RafraÃƒÆ’Ã‚Â®chissement visuel du module Gestion Eau (ÃƒÆ’Ã‚Â©tape 2, prÃƒÆ’Ã‚Â©sentation uniquement) : les ÃƒÆ’Ã‚Â©crans secondaires (Tendances, Centre d\'alertes, Rapport mensuel, Annonces, Journal d\'audit, Configuration, CoÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©, Utilisateurs, Invitations & demandes, et l\'espace Ãƒâ€šÃ‚Â« Le bassin Ãƒâ€šÃ‚Â» du propriÃƒÆ’Ã‚Â©taire) adoptent ÃƒÆ’Ã‚Â  leur tour la charte AHUVI. Les cadres et bordures gris gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©riques des cartes et des listes passent au vert clair de la charte ; les graphiques (courbes, barres, aires) puisent tous dans la mÃƒÆ’Ã‚Âªme palette de couleurs cohÃƒÆ’Ã‚Â©rente ; et les chiffres affichÃƒÆ’Ã‚Â©s en or sont assombris pour ÃƒÆ’Ã‚Âªtre nettement plus lisibles. CÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© finitions : les listes et sections apparaissent dÃƒÆ’Ã‚Â©sormais en douceur, et plusieurs boutons d\'action (modifier, supprimer, marquer comme lu/traitÃƒÆ’Ã‚Â©, fermer) sont agrandis pour ÃƒÆ’Ã‚Âªtre plus faciles ÃƒÆ’Ã‚Â  toucher du doigt. Aucun calcul, libellÃƒÆ’Ã‚Â©, donnÃƒÆ’Ã‚Â©e ni le fonctionnement hors connexion n\'est modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.53.0 : RafraÃƒÆ’Ã‚Â®chissement visuel du module Gestion Eau (ÃƒÆ’Ã‚Â©tape 1, prÃƒÆ’Ã‚Â©sentation uniquement) : les couleurs sont harmonisÃƒÆ’Ã‚Â©es ÃƒÆ’Ã‚Â  la charte AHUVI (vert et or pour l\'identitÃƒÆ’Ã‚Â©, bleu canard pour tout ce qui parle d\'eau). Les boutons Ãƒâ€šÃ‚Â« Modifier Ãƒâ€šÃ‚Â» qui ÃƒÆ’Ã‚Â©taient en bleu passent au style vert AHUVI ; les cadres et bordures gris gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©riques des cartes et des listes adoptent le vert clair de la charte ; et les graphiques (courbes, barres) puisent dÃƒÆ’Ã‚Â©sormais dans une seule palette de couleurs cohÃƒÆ’Ã‚Â©rente. La prÃƒÆ’Ã‚Â©sentation gagne aussi en finition (titres et espacements plus rÃƒÆ’Ã‚Â©guliers). Aucun calcul, libellÃƒÆ’Ã‚Â©, donnÃƒÆ’Ã‚Â©e ni le fonctionnement hors connexion n\'est modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.52.1 : Page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â» (Gestion Eau), onglet Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â» : la carte Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» adopte la mÃƒÆ’Ã‚Âªme prÃƒÆ’Ã‚Â©sentation que les cartes de l\'onglet Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â». Le bouton Ãƒâ€šÃ‚Â« Historique Ãƒâ€šÃ‚Â» disparaÃƒÆ’Ã‚Â®t ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â il suffit dÃƒÆ’Ã‚Â©sormais de toucher la carte pour ouvrir l\'historique des niveaux ; et le bouton Ãƒâ€šÃ‚Â« Saisir hauteur Ãƒâ€šÃ‚Â» pleine largeur est remplacÃƒÆ’Ã‚Â© par un petit bouton crayon, ÃƒÆ’Ã‚Â  droite, identique ÃƒÆ’Ã‚Â  celui des cartes Compteur (toucher le crayon ouvre la saisie d\'une hauteur). Changement de prÃƒÆ’Ã‚Â©sentation uniquement : les calculs, la saisie et le fonctionnement hors connexion sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.52.0 : Page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â» (Gestion Eau) : les trois onglets passent ÃƒÆ’Ã‚Â  DEUX. L\'onglet Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» ne change pas (c\'est l\'eau qui sort, la consommation). Les anciens onglets Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Apports Ãƒâ€šÃ‚Â» fusionnent dans un seul nouvel onglet Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â» (l\'eau qui entre et le stock disponible). Dans Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â», du haut vers le bas : la carte Ãƒâ€šÃ‚Â« Stock d\'eau du bassin Ãƒâ€šÃ‚Â» (le niveau disponible et l\'ÃƒÆ’Ã‚Â©cart attendu/mesurÃƒÆ’Ã‚Â©), la carte Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» (boutons Saisir hauteur / Historique), puis l\'eau qui rentre ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â d\'abord les Apports (total apportÃƒÆ’Ã‚Â© sur la pÃƒÆ’Ã‚Â©riode, bouton Ãƒâ€šÃ‚Â« Ajouter un apport Ãƒâ€šÃ‚Â», liste) puis la section dÃƒÆ’Ã‚Â©pliable Ãƒâ€šÃ‚Â« Tests de dÃƒÆ’Ã‚Â©bit Ãƒâ€šÃ‚Â» (dÃƒÆ’Ã‚Â©bit des pompes) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â et enfin la section d\'administration Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s rÃƒÆ’Ã‚Â©cents Ãƒâ€šÃ‚Â» (correction/suppression + recalcul des bilans). Tous les raccourcis et liens existants continuent de fonctionner : Ãƒâ€šÃ‚Â« Saisir bassin Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Ajouter un apport Ãƒâ€šÃ‚Â» ouvrent le bon tiroir dans Ãƒâ€šÃ‚Â« Source Ãƒâ€šÃ‚Â», et les liens du tableau de bord ou d\'invitation arrivent au bon endroit. RÃƒÆ’Ã‚Â©organisation d\'affichage uniquement : aucun calcul, aucune donnÃƒÆ’Ã‚Â©e ni le fonctionnement hors connexion ne changent. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.6 : Gestion Eau, tiroir Ãƒâ€šÃ‚Â« Saisir Ãƒâ€šÃ‚Â» d\'un relevÃƒÆ’Ã‚Â© de compteur : la photo du compteur se prend dÃƒÆ’Ã‚Â©sormais via une petite icÃƒÆ’Ã‚Â´ne d\'appareil photo placÃƒÆ’Ã‚Â©e tout en haut ÃƒÆ’Ã‚Â  droite, sur la mÃƒÆ’Ã‚Âªme ligne que le sÃƒÆ’Ã‚Â©lecteur Eau / ÃƒÆ’Ã¢â‚¬Â°lec, au lieu du grand bouton Ãƒâ€šÃ‚Â« Prendre / choisir une photo Ãƒâ€šÃ‚Â» qui occupait toute la largeur. Toucher l\'icÃƒÆ’Ã‚Â´ne ouvre l\'appareil photo ou la galerie comme avant ; une fois la photo prise, son aperÃƒÆ’Ã‚Â§u (avec le bouton Ãƒâ€šÃ‚Â« Retirer Ãƒâ€šÃ‚Â») s\'affiche juste en dessous. Changement d\'aspect uniquement : la prise de photo, les calculs et le fonctionnement (y compris hors connexion) sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.4 : Gestion Eau, page RelevÃƒÆ’Ã‚Â©s : le bouton Ãƒâ€šÃ‚Â« MODIFIER Ãƒâ€šÃ‚Â» de l\'historique d\'un compteur (rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'administrateur) permet dÃƒÆ’Ã‚Â©sormais de corriger aussi la DATE et l\'heure de chaque relevÃƒÆ’Ã‚Â©, en plus de l\'index et de la note. En mode modification, chaque relevÃƒÆ’Ã‚Â© affiche un champ Ãƒâ€šÃ‚Â« date et heure Ãƒâ€šÃ‚Â» : on peut le replacer au bon moment (une date dans le futur est refusÃƒÆ’Ã‚Â©e) ; ÃƒÆ’Ã‚Â  l\'enregistrement, la consommation est recalculÃƒÆ’Ã‚Â©e dans le bon ordre chronologique. Fonctionne pour l\'eau comme pour l\'ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©, et hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.3 : Gestion Eau, page RelevÃƒÆ’Ã‚Â©s. Dans l\'historique d\'un compteur, le bouton Ãƒâ€šÃ‚Â« MODIFIER Ãƒâ€šÃ‚Â» (rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'administrateur) passe dÃƒÆ’Ã‚Â©sormais tout en bas du tiroir, sous la liste des relevÃƒÆ’Ã‚Â©s ; le sÃƒÆ’Ã‚Â©lecteur Eau/ÃƒÆ’Ã¢â‚¬Â°lec, lui, reste en haut. Les boutons de correction adoptent une petite icÃƒÆ’Ã‚Â´ne Ãƒâ€šÃ‚Â« bloc-notes avec crayon Ãƒâ€šÃ‚Â» : sur Ãƒâ€šÃ‚Â« MODIFIER Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« ENREGISTRER Ãƒâ€šÃ‚Â» de l\'historique des compteurs, ainsi que sur le crayon de correction d\'un relevÃƒÆ’Ã‚Â© de niveau (onglet Bassin). Par ailleurs, le bouton Ãƒâ€šÃ‚Â« Scan Ãƒâ€šÃ‚Â» (QR de compteur) est dÃƒÆ’Ã‚Â©sormais intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'intÃƒÆ’Ã‚Â©rieur de l\'onglet Compteurs au lieu d\'ÃƒÆ’Ã‚Âªtre en haut de la page. Changements d\'aspect et de disposition uniquement : libellÃƒÆ’Ã‚Â©s, calculs et fonctionnement (y compris hors connexion) inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.2 : Gestion Eau, page RelevÃƒÆ’Ã‚Â©s (onglet Compteurs) : petit ajustement d\'alignement. Sur chaque carte de compteur, la ligne d\'infos (Eau Ãƒâ€šÃ‚Â· date Ãƒâ€šÃ‚Â· consommation) est dÃƒÆ’Ã‚Â©sormais alignÃƒÆ’Ã‚Â©e par le bas, sa base au niveau du bas du bouton crayon, au lieu d\'ÃƒÆ’Ã‚Âªtre collÃƒÆ’Ã‚Â©e en haut. C\'est uniquement de l\'apparence : aucun calcul, libellÃƒÆ’Ã‚Â© ni fonctionnement (y compris hors connexion) n\'est modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.1 : Gestion Eau, retouche d\'aspect des boutons Ãƒâ€šÃ‚Â« Modifier Ãƒâ€šÃ‚Â». Sur la page RelevÃƒÆ’Ã‚Â©s, le bouton Ãƒâ€šÃ‚Â« MODIFIER Ãƒâ€šÃ‚Â» (rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'administrateur, dans l\'historique d\'un compteur) adopte dÃƒÆ’Ã‚Â©sormais le mÃƒÆ’Ã‚Âªme pavÃƒÆ’Ã‚Â© bleu que le bouton Ãƒâ€šÃ‚Â« Modifier Ãƒâ€šÃ‚Â» des pages OpÃƒÆ’Ã‚Â©rations et PrÃƒÆ’Ã‚Âªts de BazarKELY, pour une prÃƒÆ’Ã‚Â©sentation cohÃƒÆ’Ã‚Â©rente dans toute l\'application ; une fois la correction commencÃƒÆ’Ã‚Â©e, le bouton Ãƒâ€šÃ‚Â« ENREGISTRER Ãƒâ€šÃ‚Â» reste vert (pour bien le distinguer). Dans l\'onglet Bassin, le petit crayon de correction d\'un relevÃƒÆ’Ã‚Â© de niveau prend lui aussi l\'accent bleu. C\'est uniquement un changement d\'apparence : les libellÃƒÆ’Ã‚Â©s, les calculs et le fonctionnement (y compris hors connexion) sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.51.0 : Page RelevÃƒÆ’Ã‚Â©s (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â finitions : un bouton crayon compact remplace le bouton Ãƒâ€šÃ‚Â« Saisir Ãƒâ€šÃ‚Â» pleine largeur sur chaque carte de compteur (onglet Compteurs) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â il s\'affiche ÃƒÆ’Ã‚Â  droite de la ligne d\'infos (ou seul ÃƒÆ’Ã‚Â  droite pour un compteur jamais relevÃƒÆ’Ã‚Â©) ; toucher le crayon ouvre la saisie d\'un relevÃƒÆ’Ã‚Â©, toucher le reste de la carte ouvre l\'historique, comme avant. Dans l\'onglet Bassin, la carte Ãƒâ€šÃ‚Â« Stock d\'eau du bassin Ãƒâ€šÃ‚Â» devient cliquable : elle dÃƒÆ’Ã‚Â©plie un court texte Ãƒâ€šÃ‚Â« Comprendre cette situation Ãƒâ€šÃ‚Â» qui explique en mots simples ce que veulent dire les chiffres du moment (tout colle, un peu plus ou un peu moins d\'eau que prÃƒÆ’Ã‚Â©vu, ou bien il manque / il y a beaucoup trop d\'eau) avec un conseil d\'action ; les chiffres restent affichÃƒÆ’Ã‚Â©s. Affichage uniquement, aucun calcul modifiÃƒÆ’Ã‚Â©, application toujours utilisable hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.50.2 : Suite du correctif de dÃƒÆ’Ã‚Â©filement des cartes Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» (Gestion Eau). Le glissement de la carte sous l\'en-tÃƒÆ’Ã‚Âªte ÃƒÆ’Ã‚Â  l\'ouverture d\'un tiroir ne se dÃƒÆ’Ã‚Â©clenchait toujours pas : le dÃƒÆ’Ã‚Â©filement ÃƒÆ’Ã‚Â©tait demandÃƒÆ’Ã‚Â© trop tÃƒÆ’Ã‚Â´t (avant que la carte ne soit prÃƒÆ’Ã‚Âªte ÃƒÆ’Ã‚Â  l\'ÃƒÆ’Ã‚Â©cran). Le dÃƒÆ’Ã‚Â©clenchement a ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© dÃƒÆ’Ã‚Â©placÃƒÆ’Ã‚Â© au bon moment du cycle d\'affichage. DÃƒÆ’Ã‚Â©sormais, ouvrir Ãƒâ€šÃ‚Â« Saisir Ãƒâ€šÃ‚Â» ou Ãƒâ€šÃ‚Â« Historique Ãƒâ€šÃ‚Â» fait bien remonter la carte juste sous l\'en-tÃƒÆ’Ã‚Âªte. Aucun autre changement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.50.1 : Correctif du dÃƒÆ’Ã‚Â©filement des cartes Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» (Gestion Eau). ÃƒÆ’Ã¢â€šÂ¬ l\'ouverture d\'un tiroir (Saisir ou Historique), la carte ne glissait pas jusque sous l\'en-tÃƒÆ’Ã‚Âªte sur les pages du module : le dÃƒÆ’Ã‚Â©filement Ãƒâ€šÃ‚Â« tout doux Ãƒâ€šÃ‚Â» rÃƒÆ’Ã‚Â©glÃƒÆ’Ã‚Â© globalement empÃƒÆ’Ã‚Âªchait l\'animation de se positionner. C\'est corrigÃƒÆ’Ã‚Â© : la carte se cale dÃƒÆ’Ã‚Â©sormais bien juste sous l\'en-tÃƒÆ’Ã‚Âªte. Aucun autre changement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.50.0 : Refonte des cartes de l\'onglet Ãƒâ€šÃ‚Â« Compteurs Ãƒâ€šÃ‚Â» (Gestion Eau). DÃƒÆ’Ã‚Â©sormais, toucher le corps d\'une carte de compteur ouvre directement son historique des relevÃƒÆ’Ã‚Â©s : le bouton Ãƒâ€šÃ‚Â« Historique Ãƒâ€šÃ‚Â» a ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© retirÃƒÆ’Ã‚Â© (devenu inutile), seul le bouton Ãƒâ€šÃ‚Â« Saisir Ãƒâ€šÃ‚Â» subsiste pour noter un nouvel index. Quand on ouvre un tiroir (Saisir ou Historique), la carte glisse en douceur pour venir se placer juste sous l\'en-tÃƒÆ’Ã‚Âªte, comme sur la page des opÃƒÆ’Ã‚Â©rations de BazarKELY, afin qu\'elle reste bien visible. NouveautÃƒÆ’Ã‚Â© rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  l\'administrateur : dans l\'historique d\'un compteur, un bouton Ãƒâ€šÃ‚Â« MODIFIER Ãƒâ€šÃ‚Â» permet de corriger l\'index et la note des 6 derniers relevÃƒÆ’Ã‚Â©s (eau ou ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©, selon ce qui est affichÃƒÆ’Ã‚Â©). DÃƒÆ’Ã‚Â¨s qu\'on change un caractÃƒÆ’Ã‚Â¨re, le bouton devient Ãƒâ€šÃ‚Â« ENREGISTRER Ãƒâ€šÃ‚Â» ; aprÃƒÆ’Ã‚Â¨s enregistrement, la consommation est recalculÃƒÆ’Ã‚Â©e et un rappel invite ÃƒÆ’Ã‚Â  lancer Ãƒâ€šÃ‚Â« Recalculer tous les bilans Ãƒâ€šÃ‚Â» (onglet Bassin) pour mettre ÃƒÆ’Ã‚Â  jour le stock du bassin et les ÃƒÆ’Ã‚Â©carts. Un releveur ou un propriÃƒÆ’Ã‚Â©taire ne voit pas ce bouton. La carte du bassin conserve son libellÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â« Stock d\'eau du bassin Ãƒâ€šÃ‚Â». MÃƒÆ’Ã‚Âªmes calculs qu\'avant, application toujours utilisable hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.49.1 : Renommage d\'affichage (Gestion Eau) : la carte Ãƒâ€šÃ‚Â« Solde du bassin Ãƒâ€šÃ‚Â» s\'intitule desormais Ãƒâ€šÃ‚Â« Stock d\'eau du bassin Ãƒâ€šÃ‚Â» (le terme Ãƒâ€šÃ‚Â« solde Ãƒâ€šÃ‚Â», herite du vocabulaire bancaire, ne convient pas a de l\'eau dans un reservoir). Affichage uniquement : aucun calcul ni fonctionnement modifie. (Detail precedent v3.49.0 : Estimation plus juste de l\'eau apportee au bassin (Gestion Eau). Jusqu\'ici, quand l\'apport d\'eau n\'etait pas saisi a la main, l\'application le deduisait du debit des pompes multiplie par la duree, ce qui le surestimait beaucoup : la pompe ne tourne pas en continu, elle remplit jusqu\'au flotteur puis s\'arrete et repart une dizaine de centimetres plus bas. Desormais, l\'apport est calcule de facon realiste a partir des niveaux du bassin et de la consommation (la pompe ne fait que compenser ce qui est sorti), sans jamais depasser le remplissage possible jusqu\'au flotteur. La carte Apports affiche maintenant cet apport estime, avec la mention estimation realiste (flotteur) ou estimation (debit) selon le cas, et le Solde du bassin utilise ce calcul plafonne (les ecarts redeviennent de vraies pertes, fini les valeurs aberrantes). Nouveau reglage facultatif en Configuration : Bande flotteur (cm) (defaut 10), la profondeur sous le flotteur a laquelle la pompe redemarre. Enfin, le test de debit se saisit desormais par hauteur + heure de debut et de fin (la duree est calculee toute seule) au lieu d\'une duree en minutes. Memes factures (basees sur les compteurs), application toujours utilisable hors connexion. (Detail precedent v3.48.1 : Correctif de cache : l\'application ne sert plus une ancienne version de la page apres une mise a jour (reglage du cache cote serveur Cloudflare + service worker). (Detail precedent v3.48.0 : Refonte de la page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â» (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ÃƒÆ’Ã‚Â©tape 2 : les onglets Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Apports Ãƒâ€šÃ‚Â» adoptent la mÃƒÆ’Ã‚Âªme prÃƒÆ’Ã‚Â©sentation en cartes que lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢onglet Compteurs. LÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢onglet Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» affiche en haut une carte Ãƒâ€šÃ‚Â« Solde du bassin Ãƒâ€šÃ‚Â» (le niveau dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢eau rÃƒÆ’Ã‚Â©ellement mesurÃƒÆ’Ã‚Â© et son pourcentage de remplissage, le niveau attendu dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢aprÃƒÆ’Ã‚Â¨s le dernier bilan et lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©cart entre les deux, en orange si une anomalie est dÃƒÆ’Ã‚Â©tectÃƒÆ’Ã‚Â©e), puis une carte Ãƒâ€šÃ‚Â« Bassin Ãƒâ€šÃ‚Â» dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢oÃƒÆ’Ã‚Â¹ lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢on ouvre, dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢une touche, la saisie dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢une nouvelle hauteur (le volume en mÃƒâ€šÃ‚Â³ se calcule en direct ; enregistrer met ÃƒÆ’Ã‚Â  jour le solde et dÃƒÆ’Ã‚Â©clenche un bilan) ou lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢historique des 6 derniers niveaux. Une section dÃƒÆ’Ã‚Â©pliable Ãƒâ€šÃ‚Â« Tests de dÃƒÆ’Ã‚Â©bit Ãƒâ€šÃ‚Â» rappelle le dÃƒÆ’Ã‚Â©bit courant des pompes et permet dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢enregistrer un nouveau test. Le nouvel onglet Ãƒâ€šÃ‚Â« Apports Ãƒâ€šÃ‚Â» regroupe les entrÃƒÆ’Ã‚Â©es dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢eau dans le bassin : un indicateur du total apportÃƒÆ’Ã‚Â© sur la pÃƒÆ’Ã‚Â©riode choisie (7 j / 30 j / 1 an), un bouton Ãƒâ€šÃ‚Â« Ajouter un apport Ãƒâ€šÃ‚Â» (volume, note et date/heure facultative) et la liste des derniers apports. Les raccourcis du bas Ãƒâ€šÃ‚Â« Saisir bassin Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Ajouter apport Ãƒâ€šÃ‚Â» ouvrent directement le bon onglet et le bon tiroir. Toutes les faÃƒÆ’Ã‚Â§ons dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢arriver ÃƒÆ’Ã‚Â  ces ÃƒÆ’Ã‚Â©crans depuis le tableau de bord ou un lien dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢invitation continuent de fonctionner comme avant, et la carte Ãƒâ€šÃ‚Â« Conso ÃƒÆ’Ã‚Â©lectrique Ãƒâ€šÃ‚Â» du tableau de bord ouvre dÃƒÆ’Ã‚Â©sormais directement la saisie dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢un relevÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â©lectrique. Pour un compteur qui a ÃƒÆ’Ã‚Â  la fois de lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢eau et de lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©, lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢historique propose un petit sÃƒÆ’Ã‚Â©lecteur Eau / ÃƒÆ’Ã¢â‚¬Â°lec. MÃƒÆ’Ã‚Âªmes calculs quÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢avant ; lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢application reste utilisable hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.47.1 : Correctif de connexion (toute lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢application). AprÃƒÆ’Ã‚Â¨s une expiration de session, lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢application pouvait refuser de rouvrir la session : au retour de Google, lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©cran qui finalise la connexion ÃƒÆ’Ã‚Â©tait sautÃƒÆ’Ã‚Â© (un indicateur interne Ãƒâ€šÃ‚Â« dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  connectÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» restait actif ÃƒÆ’Ã‚Â  tort), si bien que la connexion ne sÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©tablissait jamais et lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢espace eau affichait Ãƒâ€šÃ‚Â« Reconnexion requise Ãƒâ€šÃ‚Â» en boucle. DÃƒÆ’Ã‚Â©sormais, lorsquÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢un retour de connexion Google est en attente, lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢application le finalise toujours, mÃƒÆ’Ã‚Âªme si cet indicateur est pÃƒÆ’Ã‚Â©rimÃƒÆ’Ã‚Â©. Aucune donnÃƒÆ’Ã‚Â©e nÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢est touchÃƒÆ’Ã‚Â©e et le fonctionnement normal (connexion, navigation, hors-ligne) est inchangÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.47.0 : Refonte de la page Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â» (Gestion Eau), faÃƒÆ’Ã‚Â§on page des opÃƒÆ’Ã‚Â©rations BazarKELY. La page sÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢organise dÃƒÆ’Ã‚Â©sormais en trois onglets ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Compteurs, Bassin, Apports ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â avec un bouton Ãƒâ€šÃ‚Â« Scan Ãƒâ€šÃ‚Â» intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â© directement ÃƒÆ’Ã‚Â  la page. LÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢onglet Compteurs, entiÃƒÆ’Ã‚Â¨rement repensÃƒÆ’Ã‚Â©, affiche en haut deux indicateurs (la consommation dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢eau sur la pÃƒÆ’Ã‚Â©riode choisie et lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢avancement des relevÃƒÆ’Ã‚Â©s du jour, X/N), une barre de recherche (par nom, propriÃƒÆ’Ã‚Â©taire ou zone) et des filtres de pÃƒÆ’Ã‚Â©riode 7 j / 30 j / 1 an (mÃƒÆ’Ã‚Â©morisÃƒÆ’Ã‚Â©s). En dessous, chaque compteur est prÃƒÆ’Ã‚Â©sentÃƒÆ’Ã‚Â© sur une carte ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â eau et ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© rÃƒÆ’Ã‚Â©unis dans la mÃƒÆ’Ã‚Âªme liste, repÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â©s par une icÃƒÆ’Ã‚Â´ne (goutte pour lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢eau, ÃƒÆ’Ã‚Â©clair pour lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â montrant le dernier index, sa date et la derniÃƒÆ’Ã‚Â¨re consommation (mÃƒâ€šÃ‚Â³ ou kWh). Les compteurs encore ÃƒÆ’Ã‚Â  relever aujourdÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢hui (et ceux jamais relevÃƒÆ’Ã‚Â©s) remontent en haut, dans lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ordre de la tournÃƒÆ’Ã‚Â©e. Chaque carte ouvre, dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢une touche, un tiroir Ãƒâ€šÃ‚Â« Saisir Ãƒâ€šÃ‚Â» (nouvel index, consommation calculÃƒÆ’Ã‚Â©e, alerte si valeur anormale, case Ãƒâ€šÃ‚Â« compteur remis ÃƒÆ’Ã‚Â  zÃƒÆ’Ã‚Â©ro Ãƒâ€šÃ‚Â», photo et note facultatives ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â au choix eau ou ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©) ou un tiroir Ãƒâ€šÃ‚Â« Historique Ãƒâ€šÃ‚Â» (les 6 derniers relevÃƒÆ’Ã‚Â©s et un petit graphique). Trois raccourcis en bas (Scanner, Saisir bassin, Ajouter apport) complÃƒÆ’Ã‚Â¨tent lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã‚Â©cran. La saisie du bassin (onglet Bassin) et le scan dÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢un QR de compteur fonctionnent exactement comme avant ; lÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢onglet Ãƒâ€šÃ‚Â« Apports Ãƒâ€šÃ‚Â» arrive prochainement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.12 : ÃƒÆ’Ã¢â€šÂ¬ la rÃƒÆ’Ã‚Â©ouverture, l\'application revient automatiquement sur le tableau de bord de votre dernier module utilisÃƒÆ’Ã‚Â© (Gestion Eau, Construction ou BazarKELY), y compris quand vous lancez l\'app installÃƒÆ’Ã‚Â©e depuis son icÃƒÆ’Ã‚Â´ne. Avant, l\'app installÃƒÆ’Ã‚Â©e s\'ouvrait toujours sur BazarKELY quel que soit le module quittÃƒÆ’Ã‚Â©. Ouvrir un lien direct, un signet ou rafraÃƒÆ’Ã‚Â®chir (F5) une adresse prÃƒÆ’Ã‚Â©cise vous y maintient toujours, comme avant ; seul un lancement Ãƒâ€šÃ‚Â« neutre Ãƒâ€šÃ‚Â» (icÃƒÆ’Ã‚Â´ne de l\'app ou page d\'accueil) dÃƒÆ’Ã‚Â©clenche cette reprise. Le dernier module est dÃƒÆ’Ã‚Â©sormais mÃƒÆ’Ã‚Â©morisÃƒÆ’Ã‚Â© que vous y entriez par le sÃƒÆ’Ã‚Â©lecteur ou par un lien direct. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.10 : Le releveur peut corriger un relevÃƒÆ’Ã‚Â© de niveau rÃƒÆ’Ã‚Â©cent (Gestion Eau). La section dÃƒÆ’Ã‚Â©pliable Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s rÃƒÆ’Ã‚Â©cents Ãƒâ€šÃ‚Â» de la saisie bassin (onglet Niveau), jusqu\'ici rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  l\'administrateur, est dÃƒÆ’Ã‚Â©sormais aussi accessible au releveur ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â mais limitÃƒÆ’Ã‚Â©e aux relevÃƒÆ’Ã‚Â©s des derniÃƒÆ’Ã‚Â¨res 48 heures : il peut corriger la hauteur et la date/heure d\'un relevÃƒÆ’Ã‚Â© rÃƒÆ’Ã‚Â©cent, ou le supprimer, et les bilans concernÃƒÆ’Ã‚Â©s se recalculent tout seuls. Les relevÃƒÆ’Ã‚Â©s plus anciens ne s\'affichent pas pour le releveur (un message le lui rappelle) et le bouton Ãƒâ€šÃ‚Â« Recalculer tous les bilans Ãƒâ€šÃ‚Â» reste rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'administrateur. L\'administrateur, lui, garde l\'accÃƒÆ’Ã‚Â¨s complet (tous les relevÃƒÆ’Ã‚Â©s, sans limite de temps) exactement comme avant. Cette limite des 48 heures est aussi appliquÃƒÆ’Ã‚Â©e cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur, pas seulement ÃƒÆ’Ã‚Â  l\'ÃƒÆ’Ã‚Â©cran. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.9 : Tableau de bord Gestion Eau : nouvelle carte Ãƒâ€šÃ‚Â« Conso ÃƒÆ’Ã‚Â©lectrique Ãƒâ€šÃ‚Â» (finitions ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©). Le tableau de bord affiche dÃƒÆ’Ã‚Â©sormais, ÃƒÆ’Ã‚Â  cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© des indicateurs de l\'eau, la consommation ÃƒÆ’Ã‚Â©lectrique rÃƒÆ’Ã‚Â©cente (somme des derniÃƒÆ’Ã‚Â¨res consommations relevÃƒÆ’Ã‚Â©es par compteur, en kWh) ; tant qu\'aucun relevÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â©lectrique n\'a ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© saisi, la carte montre un ÃƒÆ’Ã‚Â©tat vide clair (Ãƒâ€šÃ‚Â« Aucun relevÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â©lectrique ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â appuyez pour saisir Ãƒâ€šÃ‚Â») et la toucher ouvre directement la saisie des relevÃƒÆ’Ã‚Â©s ÃƒÆ’Ã‚Â©lectriques. Petite fiabilisation au passage : relever un compteur ÃƒÆ’Ã‚Â©lectrique avec exactement le mÃƒÆ’Ã‚Âªme index que la fois prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dente (consommation nulle, par exemple un logement inoccupÃƒÆ’Ã‚Â©) ne dÃƒÆ’Ã‚Â©clenche plus de fausse alerte Ãƒâ€šÃ‚Â« consommation anormalement basse Ãƒâ€šÃ‚Â». Le reste du module (eau et ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©) est inchangÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.8 : Mise au point de la facture combinÃƒÆ’Ã‚Â©e eau + ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© (Gestion Eau) : le PDF affiche dÃƒÆ’Ã‚Â©sormais le logo AHUVI en en-tÃƒÆ’Ã‚Âªte, les colonnes Ãƒâ€šÃ‚Â« Prix unitaire Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Total Ãƒâ€šÃ‚Â» des tableaux ne se chevauchent plus pour les gros montants (la devise est rappelÃƒÆ’Ã‚Â©e dans l\'en-tÃƒÆ’Ã‚Âªte de ces colonnes), et l\'encadrÃƒÆ’Ã‚Â© du calcul du prix du kWh (A : JIRAMA, B : gasoil, C : kWh, D = (A+B)/C) est prÃƒÆ’Ã‚Â©sentÃƒÆ’Ã‚Â© sur quatre lignes bien lisibles ; les montants et la pÃƒÆ’Ã‚Â©riode sont dÃƒÆ’Ã‚Â©sormais alignÃƒÆ’Ã‚Â©s proprement, sans dÃƒÆ’Ã‚Â©bordement ni troncature au bord droit. Le calcul et les montants sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.6 : Nouveau : facture combinÃƒÆ’Ã‚Â©e eau + ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© (Gestion Eau, ÃƒÆ’Ã‚Â©tape finale). Dans l\'ÃƒÆ’Ã‚Â©cran Ãƒâ€šÃ‚Â« Facturation Ãƒâ€šÃ‚Â», aprÃƒÆ’Ã‚Â¨s avoir choisi la pÃƒÆ’Ã‚Â©riode, on choisit aussi le Ãƒâ€šÃ‚Â« mois de coÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» (qui fixe le prix du kWh) : chaque facture additionne dÃƒÆ’Ã‚Â©sormais une ligne EAU (consommation ÃƒÆ’Ã¢â‚¬â€ tarif au mÃƒâ€šÃ‚Â³) et une ligne ÃƒÆ’Ã¢â‚¬Â°LECTRICITÃƒÆ’Ã¢â‚¬Â° (consommation ÃƒÆ’Ã¢â‚¬â€ prix du kWh du mois choisi), avec un total gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ral. Une villa sans relevÃƒÆ’Ã‚Â© d\'un cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© n\'est facturÃƒÆ’Ã‚Â©e que pour l\'autre. L\'aperÃƒÆ’Ã‚Â§u et la liste affichent le dÃƒÆ’Ã‚Â©tail eau / ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© / total. Le PDF de facture est entiÃƒÆ’Ã‚Â¨rement remodelÃƒÆ’Ã‚Â© (charte AHUVI) : logo, en-tÃƒÆ’Ã‚Âªte propriÃƒÆ’Ã‚Â©taire + villa, deux tableaux (ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© et eau, avec index de dÃƒÆ’Ã‚Â©but/fin, consommation et prix unitaire), un encadrÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â« calcul du prix du kWh Ãƒâ€šÃ‚Â» (A : facture JIRAMA, B : gasoil, C : kWh produits, D = (A+B)/C) pour la transparence, le grand total et le montant ÃƒÆ’Ã‚Â©crit en toutes lettres (Ãƒâ€šÃ‚Â« Soit ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ariary Ãƒâ€šÃ‚Â»). S\'il n\'y a pas encore de mois de coÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©, un message invite ÃƒÆ’Ã‚Â  les saisir d\'abord (menu Ãƒâ€šÃ‚Â« CoÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â») et seules les lignes d\'eau sont facturÃƒÆ’Ã‚Â©es. Le propriÃƒÆ’Ã‚Â©taire retrouve ce mÃƒÆ’Ã‚Âªme PDF pour ses factures. Rien d\'autre ne change. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.5 : Nouveau : relevÃƒÆ’Ã‚Â© de l\'ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© par villa (Gestion Eau, 2ÃƒÂ¡Ã‚ÂµÃ¢â‚¬Â° ÃƒÆ’Ã‚Â©tape de la facture combinÃƒÆ’Ã‚Â©e eau + ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©). Dans l\'ÃƒÆ’Ã‚Â©cran Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â», un nouvel onglet Ãƒâ€šÃ‚Â« ÃƒÆ’Ã¢â‚¬Â°lectricitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» (icÃƒÆ’Ã‚Â´ne ÃƒÆ’Ã‚Â©clair) permet au releveur ou ÃƒÆ’Ã‚Â  l\'administrateur de noter l\'index du compteur ÃƒÆ’Ã¢â‚¬Â°LECTRIQUE (en kWh) de chaque villa, exactement comme pour l\'eau : on cherche la villa (ce sont les mÃƒÆ’Ã‚Âªmes que pour l\'eau), l\'app affiche le dernier index relevÃƒÆ’Ã‚Â© et sa date, on saisit le nouvel index, et la consommation (en kWh) s\'affiche aussitÃƒÆ’Ã‚Â´t. Comme pour l\'eau, l\'app prÃƒÆ’Ã‚Â©vient si l\'index saisi est plus bas que le prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent (compteur remplacÃƒÆ’Ã‚Â© : Ãƒâ€šÃ‚Â« rupture Ãƒâ€šÃ‚Â») ou si la consommation paraÃƒÆ’Ã‚Â®t anormale, et demande confirmation ; on peut joindre une photo du compteur. Un petit graphique montre la consommation des derniers relevÃƒÆ’Ã‚Â©s. CÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© propriÃƒÆ’Ã‚Â©taire, l\'onglet Ãƒâ€šÃ‚Â« Ma conso Ãƒâ€šÃ‚Â» affiche dÃƒÆ’Ã‚Â©sormais, sous chaque compteur, une section Ãƒâ€šÃ‚Â« ÃƒÆ’Ã¢â‚¬Â°lectricitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» en lecture seule : dernier index kWh et historique de consommation (tant qu\'aucun relevÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â©lectrique n\'existe, un message discret l\'indique). Le promoteur garde sa lecture seule ; rien d\'autre ne change. La facturation de l\'ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© avec l\'eau arrive aux ÃƒÆ’Ã‚Â©tapes suivantes. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.4 : Ãƒâ€šÃ‚Â« CoÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© du mois Ãƒâ€šÃ‚Â» (Gestion Eau, 1ÃƒÅ Ã‚Â³ÃƒÂ¡Ã‚ÂµÃ¢â‚¬Â° ÃƒÆ’Ã‚Â©tape de la facture combinÃƒÆ’Ã‚Â©e eau + ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â©). Un nouvel ÃƒÆ’Ã‚Â©cran (menu en haut ÃƒÆ’Ã‚Â  droite ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Ãƒâ€šÃ‚Â« CoÃƒÆ’Ã‚Â»ts ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â») permet ÃƒÆ’Ã‚Â  l\'administrateur d\'enregistrer, pour chaque mois, le coÃƒÆ’Ã‚Â»t de l\'ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© de la centrale : (A) la facture JIRAMA, (B) le gasoil du groupe ÃƒÆ’Ã‚Â©lectrogÃƒÆ’Ã‚Â¨ne et (C) le nombre total de kWh produits. L\'application en dÃƒÆ’Ã‚Â©duit aussitÃƒÆ’Ã‚Â´t (D) le prix d\'un kWh = (A + B) ÃƒÆ’Ã‚Â· C, affichÃƒÆ’Ã‚Â© en direct pendant la saisie puis conservÃƒÆ’Ã‚Â©. On peut ajouter plusieurs mois, les modifier ou les supprimer ; rÃƒÆ’Ã‚Â©-enregistrer un mois met simplement ÃƒÆ’Ã‚Â  jour ses chiffres (jamais de doublon). Si le total de kWh n\'est pas encore connu, le prix n\'est pas calculÃƒÆ’Ã‚Â© (un message le rappelle). Le promoteur et le releveur peuvent consulter cet ÃƒÆ’Ã‚Â©cran en lecture seule ; un propriÃƒÆ’Ã‚Â©taire n\'y a pas accÃƒÆ’Ã‚Â¨s. Cette ÃƒÆ’Ã‚Â©tape pose aussi, en coulisses, de quoi relever les compteurs ÃƒÆ’Ã‚Â©lectriques et joindre l\'ÃƒÆ’Ã‚Â©lectricitÃƒÆ’Ã‚Â© aux factures (volets prÃƒÆ’Ã‚Â©vus aux ÃƒÆ’Ã‚Â©tapes suivantes) ; rien d\'autre ne change dans l\'application. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.3 : Correctif (Gestion Eau) : le lien Ãƒâ€šÃ‚Â« Aller ÃƒÆ’Ã‚Â  la configuration Ãƒâ€šÃ‚Â» de la page Facturation ouvre dÃƒÆ’Ã‚Â©sormais directement la page Configuration. Avant, ce lien rechargeait toute l\'application et, le temps que vos droits d\'administrateur soient reconnus, vous ÃƒÆ’Ã‚Â©tiez renvoyÃƒÆ’Ã‚Â© ailleurs ; il fonctionne maintenant comme une navigation interne (sans rechargement), exactement comme les autres boutons du module. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.2 : On dit dÃƒÆ’Ã‚Â©sormais Ãƒâ€šÃ‚Â« PropriÃƒÆ’Ã‚Â©taire Ãƒâ€šÃ‚Â» au lieu de Ãƒâ€šÃ‚Â« Client Ãƒâ€šÃ‚Â» (Gestion Eau). Dans tout le module Eau, le mot affichÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â« Client Ãƒâ€šÃ‚Â» est remplacÃƒÆ’Ã‚Â© par Ãƒâ€šÃ‚Â« PropriÃƒÆ’Ã‚Â©taire Ãƒâ€šÃ‚Â» : la case du rÃƒÆ’Ã‚Â´le lors d\'une invitation et de la validation d\'une demande, les badges, l\'ÃƒÆ’Ã‚Â©cran Ãƒâ€šÃ‚Â« Utilisateurs Ãƒâ€šÃ‚Â» (Ãƒâ€šÃ‚Â« Comptes propriÃƒÆ’Ã‚Â©taires Ãƒâ€šÃ‚Â», Ãƒâ€šÃ‚Â« Nouveau compte propriÃƒÆ’Ã‚Â©taire Ãƒâ€šÃ‚Â»ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦), les messages du scan de QR, le journal et les textes d\'aide. C\'est uniquement un changement de vocabulaire ÃƒÆ’Ã‚Â  l\'ÃƒÆ’Ã‚Â©cran : rien ne change dans le fonctionnement, les accÃƒÆ’Ã‚Â¨s, les rÃƒÆ’Ã‚Â´les ni les donnÃƒÆ’Ã‚Â©es ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â un propriÃƒÆ’Ã‚Â©taire accÃƒÆ’Ã‚Â¨de ÃƒÆ’Ã‚Â  son espace exactement comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.1 : Chiffres de consommation et de pertes du bassin plus rÃƒÆ’Ã‚Â©alistes (Gestion Eau, suite). Cet aprÃƒÆ’Ã‚Â¨s-midi, l\'affichage Ãƒâ€šÃ‚Â« consommation estimÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» (tableau de bord et courbe) avait dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© corrigÃƒÆ’Ã‚Â©. Cette mise ÃƒÆ’Ã‚Â  jour corrige aussi le calcul de fond (le Ãƒâ€šÃ‚Â« moteur des bilans Ãƒâ€šÃ‚Â») : jusqu\'ici il supposait que la pompe tournait sans arrÃƒÆ’Ã‚Âªt, ce qui gonflait la consommation rÃƒÆ’Ã‚Â©seau estimÃƒÆ’Ã‚Â©e et les pertes. DÃƒÆ’Ã‚Â©sormais il tient compte du fait que la pompe se coupe quand le bassin est plein (elle ne tourne pas en continu). ConsÃƒÆ’Ã‚Â©quence : le chiffre Ãƒâ€šÃ‚Â« Conso rÃƒÆ’Ã‚Â©seau (pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â» et les pertes affichÃƒÆ’Ã‚Â©es baissent vers des valeurs rÃƒÆ’Ã‚Â©alistes, et certaines fausses alertes d\'anomalie (dues ÃƒÆ’Ã‚Â  cette surestimation) disparaissent. La facturation (basÃƒÆ’Ã‚Â©e sur les compteurs) n\'est pas affectÃƒÆ’Ã‚Â©e. Note : pour appliquer ces nouveaux chiffres aux relevÃƒÆ’Ã‚Â©s DÃƒÆ’Ã¢â‚¬Â°JÃƒÆ’Ã¢â€šÂ¬ enregistrÃƒÆ’Ã‚Â©s, l\'administrateur lance une fois Ãƒâ€šÃ‚Â« Recalculer tous les bilans Ãƒâ€šÃ‚Â» (onglet Niveau de la saisie bassin) ; les nouveaux relevÃƒÆ’Ã‚Â©s sont dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  calculÃƒÆ’Ã‚Â©s correctement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.46.0 : Le propriÃƒÆ’Ã‚Â©taire peut voir la situation du bassin commun (Gestion Eau). Les propriÃƒÆ’Ã‚Â©taires (qui ne voyaient que Ãƒâ€šÃ‚Â« Ma conso Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Mes factures Ãƒâ€šÃ‚Â») disposent dÃƒÆ’Ã‚Â©sormais d\'un nouvel onglet Ãƒâ€šÃ‚Â« Le bassin Ãƒâ€šÃ‚Â» : il affiche, EN LECTURE SEULE, le niveau d\'eau actuel du bassin commun, son pourcentage de remplissage, l\'autonomie estimÃƒÆ’Ã‚Â©e et la consommation du jour, ainsi qu\'une courbe du niveau sur 30 jours. C\'est une simple consultation : aucune saisie ni modification n\'est possible (le serveur lui-mÃƒÆ’Ã‚Âªme empÃƒÆ’Ã‚Âªche toute ÃƒÆ’Ã‚Â©criture sur les donnÃƒÆ’Ã‚Â©es du bassin). Les autres rÃƒÆ’Ã‚Â´les (administrateur, releveur, promoteur) et les ÃƒÆ’Ã‚Â©crans Ãƒâ€šÃ‚Â« Ma conso Ãƒâ€šÃ‚Â» / Ãƒâ€šÃ‚Â« Mes factures Ãƒâ€šÃ‚Â» ne changent pas. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.45.2 : Consommation estimÃƒÆ’Ã‚Â©e plus rÃƒÆ’Ã‚Â©aliste : on tient compte des coupures de pompe (Gestion Eau). Tant que les compteurs ne sont pas installÃƒÆ’Ã‚Â©s, la consommation d\'eau est estimÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  partir du dÃƒÆ’Ã‚Â©bit des pompes et des niveaux du bassin. Mais quand le bassin est plein, la pompe se coupe toute seule (flotteur) : sur ces pÃƒÆ’Ã‚Â©riodes, supposer la pompe en marche continue gonflait l\'estimation (on voyait des journÃƒÆ’Ã‚Â©es ÃƒÆ’Ã‚Â  80ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“140 mÃƒâ€šÃ‚Â³ alors que la vraie consommation tourne autour de 18 mÃƒâ€šÃ‚Â³/jour). DÃƒÆ’Ã‚Â©sormais, l\'application repÃƒÆ’Ã‚Â¨re les pÃƒÆ’Ã‚Â©riodes Ãƒâ€šÃ‚Â« bassin plein / pompe coupÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â» et y applique le rythme de consommation rÃƒÆ’Ã‚Â©ellement observÃƒÆ’Ã‚Â© quand le bassin se vidait, au lieu du dÃƒÆ’Ã‚Â©bit thÃƒÆ’Ã‚Â©orique. RÃƒÆ’Ã‚Â©sultat : le chiffre Ãƒâ€šÃ‚Â« Consommation du jour Ãƒâ€šÃ‚Â» du tableau de bord et la courbe Ãƒâ€šÃ‚Â« Consommation estimÃƒÆ’Ã‚Â©e par jour Ãƒâ€šÃ‚Â» (Tendances) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ainsi que la projection en pointillÃƒÆ’Ã‚Â©s ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â affichent enfin des valeurs rÃƒÆ’Ã‚Â©alistes, du mÃƒÆ’Ã‚Âªme ordre que l\'autonomie estimÃƒÆ’Ã‚Â©e. Les pertes du rÃƒÆ’Ã‚Â©seau (~30 %) restent dÃƒÆ’Ã‚Â©duites, et dÃƒÆ’Ã‚Â¨s l\'installation des compteurs tout repasse sur la consommation rÃƒÆ’Ã‚Â©ellement mesurÃƒÆ’Ã‚Â©e. Le calcul des bilans, des pertes (NRW) et de la Ãƒâ€šÃ‚Â« Conso rÃƒÆ’Ã‚Â©seau (pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â» n\'est pas modifiÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.45.0 : Inviter un Ãƒâ€šÃ‚Â« promoteur Ãƒâ€šÃ‚Â» (Gestion Eau). Le formulaire Ãƒâ€šÃ‚Â« Nouvelle invitation Ãƒâ€šÃ‚Â» (ÃƒÆ’Ã‚Â©cran Invitations & demandes) propose dÃƒÆ’Ã‚Â©sormais le rÃƒÆ’Ã‚Â´le Promoteur, en plus d\'Administrateur, Releveur et Client ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â aussi bien pour une invitation par email que par lien WhatsApp. On peut donc inviter quelqu\'un qui pourra TOUT consulter dans l\'espace eau (en lecture seule) et rÃƒÆ’Ã‚Â©gler les seuils d\'alerte, sans rien pouvoir modifier d\'autre. DÃƒÆ’Ã‚Â¨s que la personne invitÃƒÆ’Ã‚Â©e se connecte, son accÃƒÆ’Ã‚Â¨s Ãƒâ€šÃ‚Â« promoteur Ãƒâ€šÃ‚Â» s\'active tout seul (comme pour les autres rÃƒÆ’Ã‚Â´les). Les invitations dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  envoyÃƒÆ’Ã‚Â©es affichent une pastille Ãƒâ€šÃ‚Â« Promoteur Ãƒâ€šÃ‚Â», et lorsqu\'on valide une demande d\'accÃƒÆ’Ã‚Â¨s reÃƒÆ’Ã‚Â§ue on peut aussi y attribuer le rÃƒÆ’Ã‚Â´le Promoteur. Les invitations Administrateur / Releveur / Client fonctionnent exactement comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.44.2 : Conso du jour : le trait pointillÃƒÆ’Ã‚Â© de Ãƒâ€šÃ‚Â« projection Ãƒâ€šÃ‚Â» s\'affiche dÃƒÆ’Ã‚Â©sormais aussi tÃƒÆ’Ã‚Â´t le matin (Gestion Eau). Petit ajustement d\'affichage : sur la page Tendances, le segment en pointillÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â« projection (relevÃƒÆ’Ã‚Â©s en attente) Ãƒâ€šÃ‚Â» qui prolonge la courbe jusqu\'ÃƒÆ’Ã‚Â  aujourd\'hui apparaÃƒÆ’Ã‚Â®t maintenant correctement mÃƒÆ’Ã‚Âªme dans les toutes premiÃƒÆ’Ã‚Â¨res heures de la journÃƒÆ’Ã‚Â©e (avant, ÃƒÆ’Ã‚Â  cause du dÃƒÆ’Ã‚Â©calage d\'heure, il ne se montrait qu\'ÃƒÆ’Ã‚Â  partir du milieu de matinÃƒÆ’Ã‚Â©e). Le tableau de bord et le calcul de la consommation estimÃƒÆ’Ã‚Â©e sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.44.1 : Consommation du jour : ne reste plus ÃƒÆ’Ã‚Â  zÃƒÆ’Ã‚Â©ro quand un relevÃƒÆ’Ã‚Â© manque (Gestion Eau). Sur le tableau de bord, le chiffre Ãƒâ€šÃ‚Â« Consommation du jour Ãƒâ€šÃ‚Â» et, sur la page Tendances, la courbe Ãƒâ€šÃ‚Â« Consommation par jour Ãƒâ€šÃ‚Â» pouvaient retomber ÃƒÆ’Ã‚Â  zÃƒÆ’Ã‚Â©ro les jours oÃƒÆ’Ã‚Â¹ aucun relevÃƒÆ’Ã‚Â© de niveau n\'avait encore ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© saisi ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â alors que l\'eau continue d\'ÃƒÆ’Ã‚Âªtre consommÃƒÆ’Ã‚Â©e. DÃƒÆ’Ã‚Â©sormais, tant qu\'il n\'y a pas de compteurs, l\'application ESTIME la consommation au lieu d\'afficher zÃƒÆ’Ã‚Â©ro : si les relevÃƒÆ’Ã‚Â©s tardent, elle prolonge la tendance des 3 derniers jours (le chiffre du jour monte progressivement au fil des heures) et la courbe se prolonge jusqu\'ÃƒÆ’Ã‚Â  aujourd\'hui par un trait en pointillÃƒÆ’Ã‚Â©s Ãƒâ€šÃ‚Â« projection (relevÃƒÆ’Ã‚Â©s en attente) Ãƒâ€šÃ‚Â». Une absence de relevÃƒÆ’Ã‚Â© n\'est donc plus prise pour une consommation nulle. L\'estimation tient compte d\'environ 30 % de pertes du rÃƒÆ’Ã‚Â©seau (ÃƒÆ’Ã‚Â©vaporation + fuites entre le bassin et les villas), et une petite mention sous le chiffre prÃƒÆ’Ã‚Â©cise son origine (Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e (tendanceÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦) Ãƒâ€šÃ‚Â», Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e (moyenne pÃƒÆ’Ã‚Â©riode) Ãƒâ€šÃ‚Â»ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦). Seule exception : si des compteurs existent et indiquent rÃƒÆ’Ã‚Â©ellement zÃƒÆ’Ã‚Â©ro, le zÃƒÆ’Ã‚Â©ro est conservÃƒÆ’Ã‚Â© (Ãƒâ€šÃ‚Â« mesurÃƒÆ’Ã‚Â©e (compteurs ÃƒÆ’Ã‚Â  0) Ãƒâ€šÃ‚Â») ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â on ne projette jamais par-dessus une vraie mesure. DÃƒÆ’Ã‚Â¨s l\'installation des compteurs, tout repasse automatiquement sur la consommation rÃƒÆ’Ã‚Â©ellement mesurÃƒÆ’Ã‚Â©e, sans pertes estimÃƒÆ’Ã‚Â©es. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.44.0 : Nouveau rÃƒÆ’Ã‚Â´le Ãƒâ€šÃ‚Â« Promoteur Ãƒâ€šÃ‚Â» (Gestion Eau). L\'administrateur peut dÃƒÆ’Ã‚Â©sormais dÃƒÆ’Ã‚Â©signer une personne comme Ãƒâ€šÃ‚Â« promoteur Ãƒâ€šÃ‚Â» : une nouvelle case Ãƒâ€šÃ‚Â« Promoteur Ãƒâ€šÃ‚Â» apparaÃƒÆ’Ã‚Â®t ÃƒÆ’Ã‚Â  cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© de Ãƒâ€šÃ‚Â« Administrateur Ãƒâ€šÃ‚Â» et Ãƒâ€šÃ‚Â« Releveur Ãƒâ€šÃ‚Â» dans l\'ÃƒÆ’Ã‚Â©cran Ãƒâ€šÃ‚Â« Utilisateurs & rÃƒÆ’Ã‚Â´les Ãƒâ€šÃ‚Â». Le promoteur voit TOUT l\'espace eau ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tableau de bord, relevÃƒÆ’Ã‚Â©s, suivi, compteurs et facturation (y compris TOUTES les factures), ainsi que les ÃƒÆ’Ã‚Â©crans d\'administration (configuration, utilisateurs, demandes, alertes, annonces, journal) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â mais uniquement en LECTURE : aucun bouton de saisie, de modification, de suppression, de validation, de gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ration ou de marquage ne lui est proposÃƒÆ’Ã‚Â©, et un petit repÃƒÆ’Ã‚Â¨re Ãƒâ€šÃ‚Â« Lecture seule (promoteur) Ãƒâ€šÃ‚Â» le rappelle sur chaque ÃƒÆ’Ã‚Â©cran. SEULE exception : dans la Configuration, le promoteur peut rÃƒÆ’Ã‚Â©gler les seuils d\'alerte (pourcentage et mÃƒâ€šÃ‚Â³ d\'ÃƒÆ’Ã‚Â©cart, facteur de relevÃƒÆ’Ã‚Â© aberrant, jours sans relevÃƒÆ’Ã‚Â©, bassin critique, ÃƒÆ’Ã‚Â©cart de dÃƒÆ’Ã‚Â©bit) ; tous les autres rÃƒÆ’Ã‚Â©glages lui restent en lecture seule. Les rÃƒÆ’Ã‚Â´les existants (administrateur, releveur, client/propriÃƒÆ’Ã‚Â©taire) ne changent en rien : l\'administrateur ÃƒÆ’Ã‚Â©crit partout comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.43.2 : Consommation estimÃƒÆ’Ã‚Â©e par le dÃƒÆ’Ã‚Â©bit des pompes (Gestion Eau). Tant que les compteurs d\'eau ne sont pas installÃƒÆ’Ã‚Â©s, le graphique Ãƒâ€šÃ‚Â« Consommation par jour Ãƒâ€šÃ‚Â» (Suivi ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Tendances) et le chiffre Ãƒâ€šÃ‚Â« consommation du jour Ãƒâ€šÃ‚Â» (tableau de bord) restaient ÃƒÆ’Ã‚Â  zÃƒÆ’Ã‚Â©ro, faute de relevÃƒÆ’Ã‚Â©s de compteurs. DÃƒÆ’Ã‚Â©sormais, l\'application affiche une consommation ESTIMÃƒÆ’Ã¢â‚¬Â°E dÃƒÆ’Ã‚Â©duite du dÃƒÆ’Ã‚Â©bit des pompes : tant que la pompe tourne, l\'eau apportÃƒÆ’Ã‚Â©e ÃƒÂ¢Ã¢â‚¬Â°Ã‹â€  dÃƒÆ’Ã‚Â©bit ÃƒÆ’Ã¢â‚¬â€ durÃƒÆ’Ã‚Â©e, et la consommation ÃƒÂ¢Ã¢â‚¬Â°Ã‹â€  apport ÃƒÂ¢Ã‹â€ Ã¢â‚¬â„¢ variation du niveau du bassin (les fuites et l\'ÃƒÆ’Ã‚Â©vaporation sont nÃƒÆ’Ã‚Â©gligÃƒÆ’Ã‚Â©es). Sur la page Tendances, la courbe s\'intitule alors Ãƒâ€šÃ‚Â« Consommation estimÃƒÆ’Ã‚Â©e par jour Ãƒâ€šÃ‚Â» avec une petite ÃƒÆ’Ã‚Â©tiquette Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e (dÃƒÆ’Ã‚Â©bit) Ãƒâ€šÃ‚Â» et une aide dÃƒÆ’Ã‚Â©pliable qui explique le calcul ; sur le tableau de bord, le chiffre du jour porte la mention Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e (dÃƒÆ’Ã‚Â©bit) Ãƒâ€šÃ‚Â». Si aucun test de dÃƒÆ’Ã‚Â©bit n\'a encore ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© enregistrÃƒÆ’Ã‚Â©, un message invite ÃƒÆ’Ã‚Â  en faire un (onglet DÃƒÆ’Ã‚Â©bit de la saisie bassin). DÃƒÆ’Ã‚Â¨s qu\'un seul relevÃƒÆ’Ã‚Â© de compteur existe, tout rebascule AUTOMATIQUEMENT sur la consommation rÃƒÆ’Ã‚Â©ellement mesurÃƒÆ’Ã‚Â©e (la courbe redevient Ãƒâ€šÃ‚Â« Consommation mÃƒÆ’Ã‚Â©trÃƒÆ’Ã‚Â©e par jour Ãƒâ€šÃ‚Â», sans la mention Ãƒâ€šÃ‚Â« estimÃƒÆ’Ã‚Â©e Ãƒâ€šÃ‚Â»). Aucun chiffre n\'est enregistrÃƒÆ’Ã‚Â© : l\'estimation est recalculÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  l\'affichage. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.43.1 : Correctif d\'affichage des graphiques (Gestion Eau). Les pages avec courbes ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â la courbe Ãƒâ€šÃ‚Â« Niveau du bassin Ãƒâ€šÃ‚Â» (Saisie bassin ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ onglet Niveau) et la page Tendances ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â pouvaient planter et afficher un ÃƒÆ’Ã‚Â©cran d\'erreur ÃƒÆ’Ã‚Â  cause d\'une animation d\'apparition des graphiques qui tournait en boucle. L\'animation d\'apparition est dÃƒÆ’Ã‚Â©sormais dÃƒÆ’Ã‚Â©sactivÃƒÆ’Ã‚Â©e sur tous les graphiques du module Eau : les courbes, aires et barres s\'affichent exactement comme avant (mÃƒÆ’Ã‚Âªmes chiffres, mÃƒÆ’Ã‚Âªmes couleurs), simplement sans l\'effet d\'apparition, et les pages ne plantent plus. Aucun autre changement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.43.0 : Mises ÃƒÆ’Ã‚Â  jour automatiques et propres de l\'application (sur tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone comme sur ordinateur). DÃƒÆ’Ã‚Â©sormais, quand une nouvelle version est publiÃƒÆ’Ã‚Â©e, l\'application l\'installe et l\'applique TOUTE SEULE : plus de bouton Ãƒâ€šÃ‚Â« Actualiser Ãƒâ€šÃ‚Â» ÃƒÆ’Ã‚Â  chercher, plus de manipulations, et surtout plus de Ãƒâ€šÃ‚Â« rÃƒÆ’Ã‚Â©sidus Ãƒâ€šÃ‚Â» de l\'ancienne version qui obligeaient parfois ÃƒÆ’Ã‚Â  se dÃƒÆ’Ã‚Â©connecter ou ÃƒÆ’Ã‚Â  quitter l\'application. ConcrÃƒÆ’Ã‚Â¨tement, dÃƒÆ’Ã‚Â¨s qu\'une nouvelle version est prÃƒÆ’Ã‚Âªte, l\'app active le nouveau moteur, efface les anciens fichiers en cache (SANS jamais toucher ÃƒÆ’Ã‚Â  vos donnÃƒÆ’Ã‚Â©es ni ÃƒÆ’Ã‚Â  vos saisies en attente d\'envoi hors-ligne) puis se recharge automatiquement ; un petit message Ãƒâ€šÃ‚Â« Application mise ÃƒÆ’Ã‚Â  jour ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Ãƒâ€šÃ‚Â» le confirme. Note importante : cette amÃƒÆ’Ã‚Â©lioration s\'installe AVEC la prÃƒÆ’Ã‚Â©sente version ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sur un appareil qui a encore l\'ancienne version, il faut une derniÃƒÆ’Ã‚Â¨re mise ÃƒÆ’Ã‚Â  jour Ãƒâ€šÃ‚Â« ÃƒÆ’Ã‚Â  l\'ancienne Ãƒâ€šÃ‚Â» (relancer l\'application, ou se reconnecter) pour rÃƒÆ’Ã‚Â©cupÃƒÆ’Ã‚Â©rer ce nouveau systÃƒÆ’Ã‚Â¨me ; ensuite, toutes les mises ÃƒÆ’Ã‚Â  jour suivantes seront automatiques. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.42.0 : Photos du domaine sur la page de prÃƒÆ’Ã‚Â©sentation Ãƒâ€šÃ‚Â« lien dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» (Gestion Eau). Les trois emplacements photo de cette page affichent dÃƒÆ’Ã‚Â©sormais de vraies images du domaine Itampolo Resort : le practice de golf (Ãƒâ€šÃ‚Â« Le parcours de golf prend forme. Ãƒâ€šÃ‚Â»), les RÃƒÆ’Ã‚Â©sidences (Ãƒâ€šÃ‚Â« Les RÃƒÆ’Ã‚Â©sidences, pensÃƒÆ’Ã‚Â©es pour durer. Ãƒâ€šÃ‚Â») et les villas avec piscine (Ãƒâ€šÃ‚Â« Les villas du domaine prennent vie. Ãƒâ€šÃ‚Â»). Tant qu\'une image n\'est pas encore chargÃƒÆ’Ã‚Â©e, l\'icÃƒÆ’Ã‚Â´ne de repÃƒÆ’Ã‚Â¨re reste affichÃƒÆ’Ã‚Â©e sur le fond vert ; dÃƒÆ’Ã‚Â¨s que la photo arrive, elle la recouvre. Aucun autre changement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.41.0 : Modifier ou supprimer un relevÃƒÆ’Ã‚Â© de niveau du bassin (Gestion Eau, rÃƒÆ’Ã‚Â©servÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  l\'administrateur). Sous l\'onglet Ãƒâ€šÃ‚Â« Niveau Ãƒâ€šÃ‚Â» de la saisie bassin, une nouvelle section dÃƒÆ’Ã‚Â©pliable Ãƒâ€šÃ‚Â« RelevÃƒÆ’Ã‚Â©s rÃƒÆ’Ã‚Â©cents (admin) Ãƒâ€šÃ‚Â» liste les derniers relevÃƒÆ’Ã‚Â©s (date, hauteur, volume). L\'administrateur peut corriger un relevÃƒÆ’Ã‚Â© (changer la hauteur et/ou la date-heure) ou le supprimer ; ÃƒÆ’Ã‚Â  chaque fois, les bilans concernÃƒÆ’Ã‚Â©s sont recalculÃƒÆ’Ã‚Â©s automatiquement. Un bilan compare deux relevÃƒÆ’Ã‚Â©s qui se suivent (niveau prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ niveau actuel) pour estimer la consommation et les pertes : modifier un relevÃƒÆ’Ã‚Â© ne touche donc qu\'au bilan de ce relevÃƒÆ’Ã‚Â© et ÃƒÆ’Ã‚Â  celui du relevÃƒÆ’Ã‚Â© suivant ; les autres bilans (et leur ÃƒÆ’Ã‚Â©tat Ãƒâ€šÃ‚Â« traitÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â») restent intacts. Un bouton Ãƒâ€šÃ‚Â« Recalculer tous les bilans Ãƒâ€šÃ‚Â» refait toute la sÃƒÆ’Ã‚Â©rie depuis le dÃƒÆ’Ã‚Â©but (utile une seule fois pour gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rer les bilans de relevÃƒÆ’Ã‚Â©s importÃƒÆ’Ã‚Â©s). Ces actions exigent une connexion : hors ligne, les boutons sont dÃƒÆ’Ã‚Â©sactivÃƒÆ’Ã‚Â©s. Cette section n\'apparaÃƒÆ’Ã‚Â®t QUE pour un administrateur ; un releveur ne la voit pas et ne peut pas modifier ni supprimer un relevÃƒÆ’Ã‚Â©. Bonus : enregistrer un relevÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  une date passÃƒÆ’Ã‚Â©e met aussi ÃƒÆ’Ã‚Â  jour le bilan du relevÃƒÆ’Ã‚Â© qui le suit. La saisie normale d\'un relevÃƒÆ’Ã‚Â© reste exactement comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.40.1 : Correctif d\'affichage de la page de prÃƒÆ’Ã‚Â©sentation Ãƒâ€šÃ‚Â« lien dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» (Gestion Eau, ÃƒÆ’Ã¢â‚¬Â°VO 2). Sur les emplacements des photos du domaine pas encore ajoutÃƒÆ’Ã‚Â©es, l\'icÃƒÆ’Ã‚Â´ne de repÃƒÆ’Ã‚Â¨re s\'affiche dÃƒÆ’Ã‚Â©sormais systÃƒÆ’Ã‚Â©matiquement sur le fond vert AHUVI ; auparavant, selon l\'hÃƒÆ’Ã‚Â©bergement, le fond pouvait rester vide (sans l\'icÃƒÆ’Ã‚Â´ne) parce qu\'un emplacement de photo manquant renvoie une page technique au lieu d\'une vraie Ãƒâ€šÃ‚Â« image absente Ãƒâ€šÃ‚Â». DÃƒÆ’Ã‚Â¨s que les vraies photos seront ajoutÃƒÆ’Ã‚Â©es, elles recouvrent l\'icÃƒÆ’Ã‚Â´ne et s\'affichent normalement. Aucun autre changement. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.40.0 : Nouvel ÃƒÆ’Ã‚Â©cran quand un lien d\'invitation a dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  servi (Gestion Eau). Jusqu\'ici, ouvrir un lien d\'invitation Ãƒâ€šÃ‚Â« 1sakely.org/i/ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â» dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â© (ou expirÃƒÆ’Ã‚Â©, rÃƒÆ’Ã‚Â©voquÃƒÆ’Ã‚Â©, inconnu) menait ÃƒÆ’Ã‚Â  un simple message d\'erreur. DÃƒÆ’Ã‚Â©sormais, une vraie page de prÃƒÆ’Ã‚Â©sentation s\'affiche : un mot doux rappelle que le lien a dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  servi, puis la page prÃƒÆ’Ã‚Â©sente le domaine Itampolo Resort ÃƒÆ’Ã‚Â  Nosy Be (le golf, la centrale solaire, le ponton, les RÃƒÆ’Ã‚Â©sidences) avec quelques photos, explique en deux courts paragraphes pourquoi l\'eau y est suivie avec soin, donne quatre astuces d\'utilisation, et propose enfin une petite fiche Ãƒâ€šÃ‚Â« Demander un accÃƒÆ’Ã‚Â¨s Ãƒâ€šÃ‚Â» (nom, numÃƒÆ’Ã‚Â©ro WhatsApp, email facultatif, fonction, message facultatif). En validant la fiche, on se connecte avec le compte Google de son choix et la demande part vers l\'administrateur ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â aucun lien dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â© n\'est rÃƒÆ’Ã‚Â©employÃƒÆ’Ã‚Â©. Si le lien est encore valide, l\'ÃƒÆ’Ã‚Â©cran d\'inscription habituel reste exactement le mÃƒÆ’Ã‚Âªme qu\'avant. Les photos du domaine apparaÃƒÆ’Ã‚Â®tront dÃƒÆ’Ã‚Â¨s qu\'elles seront ajoutÃƒÆ’Ã‚Â©es ; en attendant, la page reste ÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©gante (fond vert AHUVI). Hors connexion, l\'application reste prudente et montre cette page de prÃƒÆ’Ã‚Â©sentation plutÃƒÆ’Ã‚Â´t qu\'une inscription qui pourrait ne pas aboutir. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.39.0 : Inviter plusieurs personnes d\'un coup depuis le rÃƒÆ’Ã‚Â©pertoire du tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone (Gestion Eau). Sur l\'ÃƒÆ’Ã‚Â©cran Ãƒâ€šÃ‚Â« Invitations & demandes Ãƒâ€šÃ‚Â», un administrateur peut maintenant appuyer sur Ãƒâ€šÃ‚Â« Importer du rÃƒÆ’Ã‚Â©pertoire Ãƒâ€šÃ‚Â» pour choisir plusieurs contacts dans le carnet d\'adresses de son tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone : le nom et le numÃƒÆ’Ã‚Â©ro WhatsApp de chacun sont remplis tout seuls (l\'adresse email aussi si elle existe), sans saisie une par une. On choisit ensuite un rÃƒÆ’Ã‚Â´le commun (Releveur ou Administrateur) et une durÃƒÆ’Ã‚Â©e de validitÃƒÆ’Ã‚Â© commune (7, 30, 90 jours ou illimitÃƒÆ’Ã‚Â©), on peut corriger le nom/numÃƒÆ’Ã‚Â©ro ou retirer une ligne, puis Ãƒâ€šÃ‚Â« CrÃƒÆ’Ã‚Â©er les invitations Ãƒâ€šÃ‚Â» fabrique tous les liens d\'invitation d\'un coup. L\'application affiche alors la liste Ãƒâ€šÃ‚Â« Liens prÃƒÆ’Ã‚Âªts ÃƒÆ’Ã‚Â  envoyer Ãƒâ€šÃ‚Â» : pour chaque personne, un bouton Ãƒâ€šÃ‚Â« Envoyer sur WhatsApp Ãƒâ€šÃ‚Â» ouvre WhatsApp avec le message et le lien tout prÃƒÆ’Ã‚Âªts, et un bouton Ãƒâ€šÃ‚Â« Copier le lien Ãƒâ€šÃ‚Â». WhatsApp s\'ouvre un contact ÃƒÆ’Ã‚Â  la fois (l\'envoi groupÃƒÆ’Ã‚Â© automatique n\'existe pas gratuitement) : on touche Ãƒâ€šÃ‚Â« Envoyer Ãƒâ€šÃ‚Â» pour chacun. Cette fonction n\'existe que sur Android (Chrome) ; sur iPhone ou ordinateur, le bouton est affichÃƒÆ’Ã‚Â© mais dÃƒÆ’Ã‚Â©sactivÃƒÆ’Ã‚Â© avec la mention Ãƒâ€šÃ‚Â« Disponible sur Android (Chrome) Ãƒâ€šÃ‚Â», et tout le reste de l\'ÃƒÆ’Ã‚Â©cran (invitation ÃƒÆ’Ã‚Â  l\'unitÃƒÆ’Ã‚Â© par email ou par lien WhatsApp, validation des demandes reÃƒÆ’Ã‚Â§ues) fonctionne exactement comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.38.0 : PrÃƒÆ’Ã‚Â©paration (invisible) du prochain ÃƒÆ’Ã‚Â©cran d\'invitation par lien (Gestion Eau). Deux briques sont posÃƒÆ’Ã‚Â©es cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur, sans rien changer ÃƒÆ’Ã‚Â  ce que vous voyez aujourd\'hui : (1) l\'application sait dÃƒÆ’Ã‚Â©sormais demander si un lien d\'invitation Ãƒâ€šÃ‚Â« 1sakely.org/i/ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â» est encore utilisable ou non (dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â©, expirÃƒÆ’Ã‚Â©, rÃƒÆ’Ã‚Â©voquÃƒÆ’Ã‚Â©, ou inconnu) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sans dÃƒÆ’Ã‚Â©voiler aucune information personnelle ; le futur ÃƒÆ’Ã‚Â©cran d\'accueil du lien s\'en servira pour proposer l\'inscription seulement quand le lien est valide, et afficher une page de prÃƒÆ’Ã‚Â©sentation sinon. (2) La future fiche d\'accÃƒÆ’Ã‚Â¨s pourra recueillir, en plus du nom et de l\'email, le numÃƒÆ’Ã‚Â©ro WhatsApp, la fonction et un message libre : ces informations seront jointes ÃƒÆ’Ã‚Â  la demande d\'accÃƒÆ’Ã‚Â¨s envoyÃƒÆ’Ã‚Â©e ÃƒÆ’Ã‚Â  l\'administrateur. Hors connexion, l\'application reste prudente (elle considÃƒÆ’Ã‚Â¨re un lien comme Ãƒâ€šÃ‚Â« non vÃƒÆ’Ã‚Â©rifiable Ãƒâ€šÃ‚Â» plutÃƒÆ’Ã‚Â´t que de proposer une inscription trompeuse). Les ÃƒÆ’Ã‚Â©crans correspondants arrivent aux ÃƒÆ’Ã‚Â©tapes suivantes. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.37.1 : AperÃƒÆ’Ã‚Â§u WhatsApp recentrÃƒÆ’Ã‚Â© : l\'image qui s\'affiche quand on partage un lien d\'invitation Ãƒâ€šÃ‚Â« 1sakely.org/i/ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â» est dÃƒÆ’Ã‚Â©sormais composÃƒÆ’Ã‚Â©e bien au centre, pour qu\'elle reste entiÃƒÆ’Ã‚Â¨rement lisible mÃƒÆ’Ã‚Âªme quand WhatsApp la recadre en carrÃƒÆ’Ã‚Â© dans le fil de discussion. Avant, le grand pourcentage (par exemple Ãƒâ€šÃ‚Â« 76 % Ãƒâ€šÃ‚Â») et les textes ÃƒÆ’Ã‚Â©taient calÃƒÆ’Ã‚Â©s ÃƒÆ’Ã‚Â  gauche : WhatsApp rognait les bords et on ne voyait plus que Ãƒâ€šÃ‚Â« % Ãƒâ€šÃ‚Â». Tout (le pourcentage, Ãƒâ€šÃ‚Â« Niveau du bassin Ãƒâ€šÃ‚Â», la goutte Ãƒâ€šÃ‚Â« Gestion Eau AHUVI Ãƒâ€šÃ‚Â», la pastille de tendance et le bandeau d\'invitation) est maintenant ramenÃƒÆ’Ã‚Â© dans une zone centrale de sÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â© et ne se fait plus couper. Pour que WhatsApp affiche bien la nouvelle image (il garde les aperÃƒÆ’Ã‚Â§us en mÃƒÆ’Ã‚Â©moire), il faut tester avec un NOUVEAU lien d\'invitation. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.37.0 : AperÃƒÆ’Ã‚Â§u WhatsApp du lien d\'invitation (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 5 (finale). DÃƒÆ’Ã‚Â©sormais, quand on colle un lien d\'invitation Ãƒâ€šÃ‚Â« 1sakely.org/i/ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â» dans WhatsApp, un bel aperÃƒÆ’Ã‚Â§u s\'affiche tout seul : une grande image aux couleurs AHUVI montrant le niveau actuel du bassin (en pourcentage, avec sa tendance) et le titre Ãƒâ€šÃ‚Â« Gestion Eau AHUVI Ãƒâ€šÃ‚Â», accompagnÃƒÆ’Ã‚Â©e d\'un court texte d\'invitation en franÃƒÆ’Ã‚Â§ais. En touchant l\'aperÃƒÆ’Ã‚Â§u, on ouvre la page d\'accueil du lien, comme avant. Jusqu\'ici WhatsApp n\'affichait qu\'un lien nu, sans image ni texte, car il ne sait pas Ãƒâ€šÃ‚Â« lire Ãƒâ€šÃ‚Â» l\'application : l\'aperÃƒÆ’Ã‚Â§u est maintenant prÃƒÆ’Ã‚Â©parÃƒÆ’Ã‚Â© cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur au moment du partage. Si les chiffres ne sont pas disponibles, l\'image reste prÃƒÆ’Ã‚Â©sentable avec un message gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ral. ÃƒÆ’Ã¢â€šÂ¬ savoir : WhatsApp garde en mÃƒÆ’Ã‚Â©moire l\'aperÃƒÆ’Ã‚Â§u d\'un lien pendant plusieurs jours ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â comme chaque invitation a son propre lien, l\'aperÃƒÆ’Ã‚Â§u est juste au premier partage et ne change plus ensuite pour ce mÃƒÆ’Ã‚Âªme lien (sans importance : un lien = une personne). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.36.0 : Invitation par lien WhatsApp (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 4 (ÃƒÆ’Ã‚Â©cran pour crÃƒÆ’Ã‚Â©er et gÃƒÆ’Ã‚Â©rer les liens). L\'administrateur peut dÃƒÆ’Ã‚Â©sormais, depuis l\'onglet Ãƒâ€šÃ‚Â« Invitations & demandes Ãƒâ€šÃ‚Â» du module Eau, inviter quelqu\'un de DEUX faÃƒÆ’Ã‚Â§ons au choix grÃƒÆ’Ã‚Â¢ce ÃƒÆ’Ã‚Â  deux onglets : Ãƒâ€šÃ‚Â« Email Ãƒâ€šÃ‚Â» (comme avant : on connaÃƒÆ’Ã‚Â®t l\'adresse Google de la personne) ou Ãƒâ€šÃ‚Â« WhatsApp Ãƒâ€šÃ‚Â» (nouveau : on n\'a que son numÃƒÆ’Ã‚Â©ro). En mode WhatsApp, on saisit le numÃƒÆ’Ã‚Â©ro, le nom (facultatif), le ou les rÃƒÆ’Ã‚Â´les (Administrateur / Releveur / Client ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â pour un client, on coche ses compteurs) et la durÃƒÆ’Ã‚Â©e de validitÃƒÆ’Ã‚Â© du lien (7, 30, 90 jours ou illimitÃƒÆ’Ã‚Â©). ÃƒÆ’Ã¢â€šÂ¬ la crÃƒÆ’Ã‚Â©ation, l\'app gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â¨re un lien d\'invitation unique et secret Ãƒâ€šÃ‚Â« 1sakely.org/i/... Ãƒâ€šÃ‚Â» : un bouton Ãƒâ€šÃ‚Â« Envoyer sur WhatsApp Ãƒâ€šÃ‚Â» ouvre WhatsApp avec un message tout prÃƒÆ’Ã‚Âªt contenant ce lien, et l\'on peut aussi Ãƒâ€šÃ‚Â« Copier le lien Ãƒâ€šÃ‚Â» ou Ãƒâ€šÃ‚Â« Copier le message Ãƒâ€šÃ‚Â». Contrairement ÃƒÆ’Ã‚Â  l\'email, AUCUNE adresse Google n\'est imposÃƒÆ’Ã‚Â©e : la personne ouvre le lien, voit le niveau du bassin, puis se connecte avec le compte Google de son choix ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â son accÃƒÆ’Ã‚Â¨s s\'active tout seul grÃƒÆ’Ã‚Â¢ce au lien. Une nouvelle liste Ãƒâ€šÃ‚Â« Invitations par lien WhatsApp Ãƒâ€šÃ‚Â» montre chaque lien envoyÃƒÆ’Ã‚Â© avec son statut (En attente / AcceptÃƒÆ’Ã‚Â©e / ExpirÃƒÆ’Ã‚Â©e), sa date d\'expiration, et les actions Renvoyer (mÃƒÆ’Ã‚Âªme lien), Copier le lien et RÃƒÆ’Ã‚Â©voquer. L\'invitation par email et la validation des demandes reÃƒÆ’Ã‚Â§ues fonctionnent exactement comme avant. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.35.0 : Invitation par lien WhatsApp (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 2 (page d\'accueil du lien). Quand l\'invitÃƒÆ’Ã‚Â© ouvre le lien d\'invitation reÃƒÆ’Ã‚Â§u par WhatsApp, il arrive dÃƒÆ’Ã‚Â©sormais sur une vraie page d\'accueil Ãƒâ€šÃ‚Â« Gestion Eau AHUVI Ãƒâ€šÃ‚Â», sans avoir besoin de se connecter : elle affiche le niveau actuel du bassin (en pourcentage, avec une flÃƒÆ’Ã‚Â¨che de tendance et la date du relevÃƒÆ’Ã‚Â©), explique en quelques mots ÃƒÆ’Ã‚Â  quoi sert l\'application (suivi de l\'eau en temps rÃƒÆ’Ã‚Â©el, 100 % gratuit, fonctionne mÃƒÆ’Ã‚Âªme sans connexion) et propose un seul bouton Ãƒâ€šÃ‚Â« Continuer avec Google Ãƒâ€šÃ‚Â». En appuyant dessus, le lien secret est mÃƒÆ’Ã‚Â©morisÃƒÆ’Ã‚Â© puis la connexion Google dÃƒÆ’Ã‚Â©marre ; au retour, l\'accÃƒÆ’Ã‚Â¨s s\'active tout seul et l\'invitÃƒÆ’Ã‚Â© atterrit directement au bon endroit selon son rÃƒÆ’Ã‚Â´le (saisie du bassin pour un releveur/administrateur, espace personnel pour un client). Si les chiffres ne sont pas disponibles (hors connexion ou bassin non configurÃƒÆ’Ã‚Â©), la page affiche un message d\'accueil simple sans chiffre. Si le lien n\'est plus valable (dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  utilisÃƒÆ’Ã‚Â© ou expirÃƒÆ’Ã‚Â©), un message clair l\'indique aprÃƒÆ’Ã‚Â¨s la connexion, sans bloquer ni renvoyer ailleurs. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.34.0 : Invitation par lien WhatsApp (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 1 (socle). PrÃƒÆ’Ã‚Â©paration d\'un 2ÃƒÂ¡Ã‚ÂµÃ¢â‚¬Â° moyen d\'inviter quelqu\'un ÃƒÆ’Ã‚Â  l\'espace eau. Jusqu\'ici, pour donner un accÃƒÆ’Ã‚Â¨s, il fallait connaÃƒÆ’Ã‚Â®tre l\'adresse Google de la personne. DÃƒÆ’Ã‚Â©sormais l\'application sait aussi crÃƒÆ’Ã‚Â©er une invitation Ãƒâ€šÃ‚Â« par lien Ãƒâ€šÃ‚Â» : un lien d\'accÃƒÆ’Ã‚Â¨s unique et secret, que l\'administrateur pourra envoyer par WhatsApp en ne connaissant que le numÃƒÆ’Ã‚Â©ro de tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sans l\'adresse Google d\'avance. Quand la personne ouvre ce lien puis se connecte avec le compte Google de son choix, son accÃƒÆ’Ã‚Â¨s (relevÃƒÆ’Ã‚Â©, administration ou espace client avec ses compteurs) s\'active tout seul grÃƒÆ’Ã‚Â¢ce au lien, quel que soit le compte utilisÃƒÆ’Ã‚Â©. ÃƒÆ’Ã¢â€šÂ¬ cette ÃƒÆ’Ã‚Â©tape, seule la Ãƒâ€šÃ‚Â« tuyauterie Ãƒâ€šÃ‚Â» est posÃƒÆ’Ã‚Â©e (cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur et dans l\'application) ; l\'ÃƒÆ’Ã‚Â©cran pour crÃƒÆ’Ã‚Â©er ces liens et la page d\'accueil du lien arrivent aux ÃƒÆ’Ã‚Â©tapes suivantes. Un lien peut avoir une date d\'expiration et ne sert qu\'une seule fois. L\'invitation par adresse Google (dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  en place) continue de fonctionner exactement comme avant, et l\'application reste utilisable hors connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.33.0 : Invitation par email (Gestion Eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 2 : l\'ÃƒÆ’Ã‚Â©cran pour gÃƒÆ’Ã‚Â©rer les invitations arrive dans l\'application. Depuis l\'onglet Ãƒâ€šÃ‚Â« Invitations & demandes Ãƒâ€šÃ‚Â» du module Eau, un administrateur peut maintenant inviter quelqu\'un en remplissant son nom, son adresse Google, son numÃƒÆ’Ã‚Â©ro WhatsApp et son rÃƒÆ’Ã‚Â´le (Administrateur, Releveur et/ou Client ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â pour un client, on choisit ses compteurs). Un bouton Ãƒâ€šÃ‚Â« Envoyer sur WhatsApp Ãƒâ€šÃ‚Â» ouvre WhatsApp avec un message tout prÃƒÆ’Ã‚Âªt (lien d\'accÃƒÆ’Ã‚Â¨s direct + rappel d\'utiliser bien CETTE adresse Google) : il n\'y a plus qu\'ÃƒÆ’Ã‚Â  appuyer sur Envoyer. La liste des invitations envoyÃƒÆ’Ã‚Â©es (en attente / acceptÃƒÆ’Ã‚Â©es) permet de renvoyer le message ou de rÃƒÆ’Ã‚Â©voquer une invitation pas encore utilisÃƒÆ’Ã‚Â©e. Les demandes d\'accÃƒÆ’Ã‚Â¨s reÃƒÆ’Ã‚Â§ues continuent de se valider au mÃƒÆ’Ã‚Âªme endroit. DÃƒÆ’Ã‚Â¨s que l\'invitÃƒÆ’Ã‚Â© se connecte avec l\'adresse Google indiquÃƒÆ’Ã‚Â©e, son accÃƒÆ’Ã‚Â¨s s\'active tout seul (Phase 1). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.32.0 : Invitation par email (Gestion Eau) : un administrateur peut dÃƒÆ’Ã‚Â©sormais prÃƒÆ’Ã‚Â©-enregistrer une personne par son adresse Google et lui attribuer ÃƒÆ’Ã‚Â  l\'avance un rÃƒÆ’Ã‚Â´le (relevÃƒÆ’Ã‚Â© des compteurs, administration et/ou espace client avec ses compteurs). DÃƒÆ’Ã‚Â¨s que cette personne se connecte ÃƒÆ’Ã‚Â  BazarKELY avec l\'adresse Google invitÃƒÆ’Ã‚Â©e, son accÃƒÆ’Ã‚Â¨s au module Eau s\'active tout seul, sans validation manuelle ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â et si elle est invitÃƒÆ’Ã‚Â©e comme client, son espace et ses compteurs sont crÃƒÆ’Ã‚Â©ÃƒÆ’Ã‚Â©s automatiquement. (Pour l\'instant l\'invitation se dÃƒÆ’Ã‚Â©pose cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur ; l\'ÃƒÆ’Ã‚Â©cran pour gÃƒÆ’Ã‚Â©rer ces invitations depuis l\'application arrivera ÃƒÆ’Ã‚Â  l\'ÃƒÆ’Ã‚Â©tape suivante.) (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.31.4 : Correctif navigation (verrou de module) : rafraÃƒÆ’Ã‚Â®chir la page (F5 ou Shift+Ctrl+R) ou ouvrir directement l\'adresse d\'un module ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Gestion Eau (/gestion-eau), Construction (/construction/ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦) ou une page budget BazarKELY (/transactionsÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â vous maintient dÃƒÆ’Ã‚Â©sormais EXACTEMENT lÃƒÆ’Ã‚Â  oÃƒÆ’Ã‚Â¹ vous ÃƒÆ’Ã‚Â©tiez, dans tous les cas. Avant, dans le bref instant oÃƒÆ’Ã‚Â¹ l\'application restaurait votre connexion au dÃƒÆ’Ã‚Â©marrage, l\'adresse pouvait ÃƒÆ’Ã‚Âªtre remplacÃƒÆ’Ã‚Â©e par l\'ÃƒÆ’Ã‚Â©cran de connexion, et au retour vous ÃƒÆ’Ã‚Â©tiez renvoyÃƒÆ’Ã‚Â© au tableau de bord BazarKELY au lieu de votre module. DÃƒÆ’Ã‚Â©sormais l\'ÃƒÆ’Ã‚Â©cran de connexion s\'affiche sans changer l\'adresse, donc une fois la connexion restaurÃƒÆ’Ã‚Â©e vous restez sur votre module. Le seul moyen de changer de module reste le geste volontaire : logo en haut ÃƒÆ’Ã‚Â  gauche puis icÃƒÆ’Ã‚Â´ne de la barre du bas. Bonus : si vous vous connectez avec Google depuis un lien profond (par exemple /gestion-eau alors que vous ÃƒÆ’Ã‚Â©tiez dÃƒÆ’Ã‚Â©connectÃƒÆ’Ã‚Â©), vous revenez sur cette adresse aprÃƒÆ’Ã‚Â¨s connexion. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.31.3 : ouvrir ou rafraÃƒÆ’Ã‚Â®chir (F5) directement l\'adresse d\'un module (par exemple Gestion Eau /gestion-eau) vous y maintient dÃƒÆ’Ã‚Â©sormais, au lieu de vous renvoyer au tableau de bord BazarKELY. La reprise automatique Ãƒâ€šÃ‚Â« revenir dans mon dernier module utilisÃƒÆ’Ã‚Â© Ãƒâ€šÃ‚Â» est conservÃƒÆ’Ã‚Â©e, mais ne s\'applique plus que depuis l\'accueil neutre (/dashboard) : si vous arrivez par un lien, un signet ou un rechargement sur une adresse prÃƒÆ’Ã‚Â©cise, vous restez exactement lÃƒÆ’Ã‚Â . Le basculement de module via le logo en haut ÃƒÆ’Ã‚Â  gauche est inchangÃƒÆ’Ã‚Â©. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.31.2 : Tableau de bord Eau : l\'icÃƒÆ’Ã‚Â´ne d\'une carte bassin ouvre maintenant directement le bon onglet de saisie ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Stock ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Niveau, EntrÃƒÆ’Ã‚Â©es ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ EntrÃƒÆ’Ã‚Â©e, DÃƒÆ’Ã‚Â©bit ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ DÃƒÆ’Ã‚Â©bit. Avant, on tombait toujours sur Niveau quelle que soit la carte touchÃƒÆ’Ã‚Â©e. Les cartes compteur et le reste sont inchangÃƒÆ’Ã‚Â©s. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.31.1 : Correctif d\'affichage (Gestion Eau, sur tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone) : sur les ÃƒÆ’Ã‚Â©crans du module Eau, la derniÃƒÆ’Ã‚Â¨re carte du bas d\'une page n\'est plus masquÃƒÆ’Ã‚Â©e par la barre de navigation du bas ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â un petit espace apparaÃƒÆ’Ã‚Â®t dÃƒÆ’Ã‚Â©sormais entre la carte et la barre, mÃƒÆ’Ã‚Âªme quand les libellÃƒÆ’Ã‚Â©s des onglets passent sur deux lignes. Aucune autre fonction modifiÃƒÆ’Ã‚Â©e. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.31.0 : Tableau de bord Eau : chaque carte est maintenant cliquable ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â toucher le corps d\'une carte ouvre le dÃƒÆ’Ã‚Â©tail (Tendances, ou Suivi pour le NRW et le Dernier bilan), toucher son icÃƒÆ’Ã‚Â´ne ouvre directement la saisie correspondante (relevÃƒÆ’Ã‚Â© bassin ou relevÃƒÆ’Ã‚Â© compteur). Les sept cartes sont aussi rangÃƒÆ’Ã‚Â©es en deux colonnes : ÃƒÆ’Ã‚Â  gauche celles liÃƒÆ’Ã‚Â©es au bassin (Stock, EntrÃƒÆ’Ã‚Â©es, DÃƒÆ’Ã‚Â©bit), ÃƒÆ’Ã‚Â  droite celles liÃƒÆ’Ã‚Â©es aux compteurs (Conso du jour, NRW, Conso rÃƒÆ’Ã‚Â©seau, Autonomie). Les deux mini-graphiques et la carte Ãƒâ€šÃ‚Â« Dernier bilan Ãƒâ€šÃ‚Â» sont ÃƒÆ’Ã‚Â©galement cliquables. Rien d\'autre ne change : mÃƒÆ’Ã‚Âªmes chiffres, mÃƒÆ’Ã‚Âªmes couleurs, mÃƒÆ’Ã‚Âªmes icÃƒÆ’Ã‚Â´nes. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.30.1 : Saisie du bassin (Gestion Eau) : vous pouvez maintenant choisir la date et l\'heure d\'un relevÃƒÆ’Ã‚Â© de niveau ou d\'une entrÃƒÆ’Ã‚Â©e d\'eau, pour enregistrer une mesure faite plus tÃƒÆ’Ã‚Â´t. Un nouveau champ Ãƒâ€šÃ‚Â« Date et heure Ãƒâ€šÃ‚Â» (facultatif) apparaÃƒÆ’Ã‚Â®t sous la note, dans les onglets Niveau et EntrÃƒÆ’Ã‚Â©e. Si vous le laissez vide, c\'est l\'instant prÃƒÆ’Ã‚Â©sent qui est utilisÃƒÆ’Ã‚Â© (comme avant) ; si vous le remplissez, le relevÃƒÆ’Ã‚Â© est enregistrÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  la date choisie et apparaÃƒÆ’Ã‚Â®t au bon endroit sur la courbe. Une date dans le futur est refusÃƒÆ’Ã‚Â©e. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.30.0 : SÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â© du module Gestion Eau (Phase 2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â verrouillage des accÃƒÆ’Ã‚Â¨s par rÃƒÆ’Ã‚Â´le). Jusqu\'ici, mÃƒÆ’Ã‚Âªme si l\'application affichait ÃƒÆ’Ã‚Â  chacun ce qui le concernait, les donnÃƒÆ’Ã‚Â©es de l\'eau (compteurs, relevÃƒÆ’Ã‚Â©s, factures, niveau du bassin commun) restaient techniquement accessibles cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur. DÃƒÆ’Ã‚Â©sormais, le serveur lui-mÃƒÆ’Ã‚Âªme filtre tout selon votre rÃƒÆ’Ã‚Â´le : un client ne voit QUE ses propres compteurs, relevÃƒÆ’Ã‚Â©s et factures ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â jamais ceux d\'un voisin, ni le bassin commun. Le releveur peut consulter les compteurs et le bassin et saisir des relevÃƒÆ’Ã‚Â©s, mais pas les factures ni la liste des clients. L\'administrateur garde l\'accÃƒÆ’Ã‚Â¨s complet. Cette protection s\'applique partout, y compris si quelqu\'un essayait d\'interroger directement le serveur sans passer par l\'application. Le rattachement d\'un client par code et les demandes d\'accÃƒÆ’Ã‚Â¨s passent maintenant par une voie sÃƒÆ’Ã‚Â©curisÃƒÆ’Ã‚Â©e cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur. Aucune fonction visible n\'est retirÃƒÆ’Ã‚Â©e ; votre connexion (une seule fois) et le fonctionnement hors-ligne restent identiques. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.29.1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Correctif : ouvrir ou rafraÃƒÆ’Ã‚Â®chir directement l\'adresse du module Eau (/gestion-eau) ne vous renvoie plus par erreur au tableau de bord. Le problÃƒÆ’Ã‚Â¨me survenait au tout premier affichage sur un appareil (cache vide) : le module n\'avait pas encore eu le temps de rÃƒÆ’Ã‚Â©cupÃƒÆ’Ã‚Â©rer votre rÃƒÆ’Ã‚Â´le (admin/releveur) auprÃƒÆ’Ã‚Â¨s du serveur et concluait ÃƒÆ’Ã‚Â  tort Ãƒâ€šÃ‚Â« pas d\'accÃƒÆ’Ã‚Â¨s Ãƒâ€šÃ‚Â». DÃƒÆ’Ã‚Â©sormais, tant que vos droits ne sont pas confirmÃƒÆ’Ã‚Â©s (connexion lente), l\'app patiente proprement (et rÃƒÆ’Ã‚Â©essaie automatiquement) au lieu de vous ÃƒÆ’Ã‚Â©jecter ; en cas d\'ÃƒÆ’Ã‚Â©chec durable, un ÃƒÆ’Ã‚Â©cran clair Ãƒâ€šÃ‚Â« VÃƒÆ’Ã‚Â©rification de votre accÃƒÆ’Ã‚Â¨sÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Ãƒâ€šÃ‚Â» avec un bouton Ãƒâ€šÃ‚Â« RÃƒÆ’Ã‚Â©essayer Ãƒâ€šÃ‚Â» s\'affiche. Le renvoi vers l\'accueil ne se produit plus QUE si le serveur a bien rÃƒÆ’Ã‚Â©pondu et que vous n\'avez rÃƒÆ’Ã‚Â©ellement aucun rÃƒÆ’Ã‚Â´le eau. Aucune autre fonction modifiÃƒÆ’Ã‚Â©e. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.29.0 : SÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â© du module Gestion Eau (Phase 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â fondation identitÃƒÆ’Ã‚Â©). ÃƒÆ’Ã¢â€šÂ¬ l\'ouverture de l\'espace eau, l\'application vÃƒÆ’Ã‚Â©rifie dÃƒÆ’Ã‚Â©sormais que vous ÃƒÆ’Ã‚Âªtes bien connectÃƒÆ’Ã‚Â© avec VOTRE compte (la mÃƒÆ’Ã‚Âªme session sÃƒÆ’Ã‚Â©curisÃƒÆ’Ã‚Â©e que le reste de BazarKELY) avant d\'afficher quoi que ce soit. ConcrÃƒÆ’Ã‚Â¨tement : plus d\'ÃƒÆ’Ã‚Â©jection involontaire vers l\'accueil quand la connexion est lente (le module attend proprement votre session au lieu d\'abandonner), et si aucune session n\'est valide, un ÃƒÆ’Ã‚Â©cran clair Ãƒâ€šÃ‚Â« Se reconnecter avec Google Ãƒâ€šÃ‚Â» s\'affiche. Votre connexion reste mÃƒÆ’Ã‚Â©morisÃƒÆ’Ã‚Â©e : une seule connexion suffit, la session est conservÃƒÆ’Ã‚Â©e entre les fermetures de l\'app et les changements de page. CÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© administrateur, la dÃƒÆ’Ã‚Â©signation du tout premier propriÃƒÆ’Ã‚Â©taire de l\'espace eau se fait maintenant de faÃƒÆ’Ã‚Â§on fiable cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur. Aucune autre fonction modifiÃƒÆ’Ã‚Â©e ; les rÃƒÆ’Ã‚Â¨gles d\'accÃƒÆ’Ã‚Â¨s restent ouvertes pour l\'instant (le verrouillage par rÃƒÆ’Ã‚Â´le viendra en Phase 2). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.28.0 : Logo du module AHUVI Eau affinÃƒÆ’Ã‚Â© : le logo de l\'en-tÃƒÆ’Ã‚Âªte Gestion Eau utilise dÃƒÆ’Ã‚Â©sormais le visuel vectoriel officiel (carrÃƒÆ’Ã‚Â© sombre, jauge cyan, goutte d\'eau) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sans la lettre Ãƒâ€šÃ‚Â« A Ãƒâ€šÃ‚Â», avec un dÃƒÆ’Ã‚Â©gradÃƒÆ’Ã‚Â© de goutte ajustÃƒÆ’Ã‚Â©. Net ÃƒÆ’Ã‚Â  toute taille, sans requÃƒÆ’Ã‚Âªte rÃƒÆ’Ã‚Â©seau. Les autres modules (BazarKELY, Construction) gardent leur logo Ãƒâ€šÃ‚Â« B Ãƒâ€šÃ‚Â» inchangÃƒÆ’Ã‚Â© et le clic sur le logo continue de basculer entre les modules. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.27.1 : Correctif menu Gestion Eau : le bouton Ãƒâ€šÃ‚Â« Mise ÃƒÆ’Ã‚Â  jour Ãƒâ€šÃ‚Â» du menu en haut ÃƒÆ’Ã‚Â  droite reste dÃƒÆ’Ã‚Â©sormais DANS le module Eau (la page version s\'ouvre sous /gestion-eau/version au lieu de la route globale /app-version) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â fini la sensation d\'ÃƒÆ’Ã‚Âªtre ÃƒÆ’Ã‚Â©jectÃƒÆ’Ã‚Â© vers BazarKELY (le header AHUVI et la barre du bas du module restent en place). (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.27.0 : Nouveau logo du module AHUVI Eau : dans l\'en-tÃƒÆ’Ã‚Âªte de la Gestion Eau, l\'ancien carrÃƒÆ’Ã‚Â© gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rique Ãƒâ€šÃ‚Â« B Ãƒâ€šÃ‚Â» est remplacÃƒÆ’Ã‚Â© par le logo AHUVI Eau (carrÃƒÆ’Ã‚Â© sombre, jauge cyan, goutte d\'eau et lettre Ãƒâ€šÃ‚Â« A Ãƒâ€šÃ‚Â»). Les autres modules (BazarKELY, Construction) gardent leur logo Ãƒâ€šÃ‚Â« B Ãƒâ€šÃ‚Â» inchangÃƒÆ’Ã‚Â©. Le clic sur le logo continue de basculer entre les modules. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.26.1 : Correctif scan de ticket ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Quand vous supprimez (ou Ãƒâ€šÃ‚Â« restituez Ãƒâ€šÃ‚Â») une dÃƒÆ’Ã‚Â©pense scannÃƒÆ’Ã‚Â©e, son ticket et ses lignes d\'article sont dÃƒÆ’Ã‚Â©sormais supprimÃƒÆ’Ã‚Â©s EN MÃƒÆ’Ã…Â ME TEMPS, sur l\'appareil comme dans le cloud : plus de donnÃƒÆ’Ã‚Â©es orphelines qui traÃƒÆ’Ã‚Â®nent. Les anciennes donnÃƒÆ’Ã‚Â©es orphelines dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  prÃƒÆ’Ã‚Â©sentes ont aussi ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â© nettoyÃƒÆ’Ã‚Â©es. Aucun changement visible sur la suppression des opÃƒÆ’Ã‚Â©rations normales ni des transferts. (DÃƒÆ’Ã‚Â©tail prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dent v3.26.0 : Le scan de ticket gagne un 2ÃƒÂ¡Ã‚ÂµÃ¢â‚¬Â° moteur, plus prÃƒÆ’Ã‚Â©cis, qui s\'active TOUT SEUL quand vous avez Internet : Google Cloud Vision (lecture cloud haute prÃƒÆ’Ã‚Â©cision). Hors-ligne, ou si le service en ligne tombe en panne / met trop de temps, l\'app bascule automatiquement sur la lecture locale gratuite Tesseract.js (Phase 1) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â vous n\'ÃƒÆ’Ã‚Âªtes jamais bloquÃƒÆ’Ã‚Â©. La clÃƒÆ’Ã‚Â© du service reste cachÃƒÆ’Ã‚Â©e cÃƒÆ’Ã‚Â´tÃƒÆ’Ã‚Â© serveur (Netlify Function), jamais dans l\'application. Comme le texte lu en ligne est plus propre, le ticket est insÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© directement plus souvent ; l\'ÃƒÆ’Ã‚Â©cran de relecture n\'apparaÃƒÆ’Ã‚Â®t qu\'en cas de doute (lecture incertaine ou total ÃƒÂ¢Ã¢â‚¬Â°Ã‚Â  somme des lignes). Le moteur rÃƒÆ’Ã‚Â©ellement utilisÃƒÆ’Ã‚Â© est tracÃƒÆ’Ã‚Â© sur chaque ticket. Tout le reste de la Phase 1 est inchangÃƒÆ’Ã‚Â© (crÃƒÆ’Ã‚Â©ation de la dÃƒÆ’Ã‚Â©pense = total, articles ÃƒÆ’Ã‚Â©ditables, aucune image stockÃƒÆ’Ã‚Â©e))))))))).)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))';
