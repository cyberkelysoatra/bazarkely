...
const Header = () => {
  ...
  // Hook pour les mises à jour du Service Worker
                ...
                <div className="dropdown-menu absolute top-full right-0 mt-2 bg-purple-500/80 backdrop-blur-sm rounded-xl p-3 border border-purple-300/50 shadow-lg z-50 min-w-[200px]">
                  <div className="flex flex-col space-y-2">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-2 text-sm text-white/90 hover:bg-white/20 rounded-lg transition-colors"
                    >
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-xs text-white/60">v{APP_VERSION}</span>
                        {updateAvailable && (
